...
@REM
@REM Author:       samkannan{at}@us.ibm.com
@REM
@REM ##############################################################################
@REM Description:
@REM
@REM This file is a startup script for the SBLIM WBEM-SMT DHCP
...
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-dhcp-bl2-0.2.1.jar
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-dhcp-eui-cli-0.2.1.jar
SET CLASSPATH=%CLASSPATH%;lib\sblim-wbemsmt-dhcp-eui-common-0.2.1.jar
...
SET VM_OPTIONS=-Djava.util.logging.config.file=cmdlogging.properties -Dcommands=org.sblim.wbemsmt.cli.dhcp.listener.Commands
