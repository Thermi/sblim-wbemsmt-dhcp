/**
 * DhcpServiceConfeditActionListenerEditBeanSettingsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS
...
public class DhcpServiceConfeditActionListenerEditBeanSettingsTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DhcpServiceConfContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public DhcpServiceConfeditActionListenerEditBeanSettingsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DhcpServiceConfContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "DhcpServiceConfEditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DhcpServiceConfContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SettingsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DhcpServiceConfContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SettingsTab'].");
