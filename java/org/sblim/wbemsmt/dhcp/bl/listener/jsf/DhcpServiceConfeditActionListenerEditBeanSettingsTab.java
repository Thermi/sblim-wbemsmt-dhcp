/** 
  * DhcpServiceConfeditActionListenerEditBeanSettingsTab.java
  *
...
public class DhcpServiceConfeditActionListenerEditBeanSettingsTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SettingsTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DhcpServiceConfContainerImpl(adapter1,bindingPrefix);
