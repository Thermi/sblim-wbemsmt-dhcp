...
public class PooldeleteActionListener extends JsfDeleteListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        TaskLauncherTreeNodeSelector selector = new org.sblim.wbemsmt.dhcp.bl.listener.PooldeleteActionListenerSelector();
        selector.select(treeNode, adapter, "PooldeleteAction");
