...
public class SubnetdeleteActionListener extends JsfDeleteListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        TaskLauncherTreeNodeSelector selector = new org.sblim.wbemsmt.dhcp.bl.listener.SubnetdeleteActionListenerSelector();
        selector.select(treeNode, adapter, "SubnetdeleteAction");
