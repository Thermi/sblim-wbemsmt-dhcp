/** 
  * SubnetcreateActionListener.java
  *
...
public class SubnetcreateActionListener extends TaskLauncherContextMenuEventListenerImpl {
	...
	public String processEvent(TaskLauncherTreeNodeEvent event) throws org.sblim.wbemsmt.exception.WbemSmtException {
		...
		if (selector.execute())
		{
			...
			org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetWizard(adapter);
