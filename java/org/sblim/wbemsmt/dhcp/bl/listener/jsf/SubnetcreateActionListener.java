/**
 * SubnetcreateActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class SubnetcreateActionListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("DHCP", "SubnetcreateActionListener");
        ...
        TaskLauncherTreeNodeSelectorForCreate selector = new org.sblim.wbemsmt.dhcp.bl.listener.SubnetcreateActionListenerSelector();
        selector.select(treeNode, adapter, "SubnetcreateAction");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetWizard(
                    adapter);
