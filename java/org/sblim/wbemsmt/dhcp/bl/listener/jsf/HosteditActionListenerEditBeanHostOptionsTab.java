/** 
  * HosteditActionListenerEditBeanHostOptionsTab.java
  *
...
public class HosteditActionListenerEditBeanHostOptionsTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['HostOptionsTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPHostOptionsContainerImpl(adapter1,bindingPrefix);
