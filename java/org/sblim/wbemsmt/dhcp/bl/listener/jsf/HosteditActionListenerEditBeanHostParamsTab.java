/**
 * HosteditActionListenerEditBeanHostParamsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class HosteditActionListenerEditBeanHostParamsTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPHostParamsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public HosteditActionListenerEditBeanHostParamsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPHostParamsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.HosteditActionListenerSelectors.HostParamsTabHostParamseditPanelSelector();
        selector.select(treeNode, adapter1, "HostParamseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPHostParamsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['HostParamsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPHostParamsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['HostParamsTab'].");
