/**
 * DhcpServiceConfeditActionListenerEditBeanGlobalParamsTab.java Â© Copyright IBM Corp.  2009,2006,2007
...
public class DhcpServiceConfeditActionListenerEditBeanGlobalParamsTab extends EditBean {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['GlobalParamsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPGlobalParamsContainerImpl(
