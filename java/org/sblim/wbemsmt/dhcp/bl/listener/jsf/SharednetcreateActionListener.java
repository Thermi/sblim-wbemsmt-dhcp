...
public class SharednetcreateActionListener extends TaskLauncherContextMenuEventListenerImpl {
	...
	public String processEvent(TaskLauncherTreeNodeEvent event) throws org.sblim.wbemsmt.exception.WbemSmtException {
		...
		if (selector.execute())
		{
			...
			org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSharednetWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSharednetWizard(adapter);
