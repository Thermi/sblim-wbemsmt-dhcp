/**
 * HosteditActionListenerEditBeanHostTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class HosteditActionListenerEditBeanHostTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPHostsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public HosteditActionListenerEditBeanHostTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPHostsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.HosteditActionListenerSelectors.HostTabHosteditPanelSelector();
        selector.select(treeNode, adapter1, "HosteditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPHostsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['HostTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPHostsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['HostTab'].");
