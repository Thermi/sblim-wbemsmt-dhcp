...
public class GroupeditActionListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("DHCP", "GroupeditActionListener");
        ...
        bean = new org.sblim.wbemsmt.dhcp.bl.listener.jsf.GroupeditActionListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
