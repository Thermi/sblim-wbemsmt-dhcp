/**
 * SubneteditActionListenerEditBeanSubnetOptionsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE
...
public class SubneteditActionListenerEditBeanSubnetOptionsTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetOptionsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SubneteditActionListenerEditBeanSubnetOptionsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPSubnetOptionsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.SubneteditActionListenerSelectors.SubnetOptionsTabSubnetoptionseditPanelSelector();
        selector.select(treeNode, adapter1, "SubnetoptionseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPSubnetOptionsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SubnetOptionsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetOptionsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SubnetOptionsTab'].");
