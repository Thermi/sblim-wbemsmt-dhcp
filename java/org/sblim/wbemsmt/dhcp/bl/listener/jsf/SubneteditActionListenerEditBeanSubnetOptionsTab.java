/** 
  * SubneteditActionListenerEditBeanSubnetOptionsTab.java
  *
...
public class SubneteditActionListenerEditBeanSubnetOptionsTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SubnetOptionsTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetOptionsContainerImpl(adapter1,bindingPrefix);
