/**
 * PooleditActionListenerEditBeanPoolOptionsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class PooleditActionListenerEditBeanPoolOptionsTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolOptionsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public PooleditActionListenerEditBeanPoolOptionsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPPoolOptionsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.PooleditActionListenerSelectors.PoolOptionsTabPoolOptionseditPanelSelector();
        selector.select(treeNode, adapter1, "PoolOptionseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPPoolOptionsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['PoolOptionsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolOptionsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['PoolOptionsTab'].");
