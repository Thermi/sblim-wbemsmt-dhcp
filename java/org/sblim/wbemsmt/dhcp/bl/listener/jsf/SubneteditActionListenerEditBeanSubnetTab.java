/**
 * SubneteditActionListenerEditBeanSubnetTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class SubneteditActionListenerEditBeanSubnetTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SubneteditActionListenerEditBeanSubnetTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPSubnetsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.SubneteditActionListenerSelectors.SubnetTabSubneteditPanelSelector();
        selector.select(treeNode, adapter1, "SubneteditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPSubnetsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SubnetTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SubnetTab'].");
