/** 
  * SubneteditActionListenerEditBeanSubnetTab.java
  *
...
public class SubneteditActionListenerEditBeanSubnetTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SubnetTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetsContainerImpl(adapter1,bindingPrefix);
