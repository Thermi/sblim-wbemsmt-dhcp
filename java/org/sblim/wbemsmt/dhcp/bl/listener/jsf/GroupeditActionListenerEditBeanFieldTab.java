...
public class GroupeditActionListenerEditBeanFieldTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPGroupsContainerImpl(adapter1,bindingPrefix);
				...
				//create cotainner
    			currentEditContainer2 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPGroupOptionsContainerImpl(adapter2,bindingPrefix);
				...
				//create cotainner
    			currentEditContainer3 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPGroupParamsContainerImpl(adapter3,bindingPrefix);
