/** 
  * SharedneteditActionListenerEditBeanSharednetParamTab.java
  *
...
public class SharedneteditActionListenerEditBeanSharednetParamTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SharednetParamTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednetParamsContainerImpl(adapter1,bindingPrefix);
