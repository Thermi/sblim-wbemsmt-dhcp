/**
 * SharedneteditActionListenerEditBeanSharednetParamTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS
...
public class SharedneteditActionListenerEditBeanSharednetParamTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednetParamsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SharedneteditActionListenerEditBeanSharednetParamTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPSharednetParamsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.SharedneteditActionListenerSelectors.SharednetParamTabSharednetParamseditPanelSelector();
        selector.select(treeNode, adapter1, "SharednetParamseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPSharednetParamsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SharednetParamTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednetParamsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SharednetParamTab'].");
