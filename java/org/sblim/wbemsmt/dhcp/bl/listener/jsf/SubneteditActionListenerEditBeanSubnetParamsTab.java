/** 
  * SubneteditActionListenerEditBeanSubnetParamsTab.java
  *
...
public class SubneteditActionListenerEditBeanSubnetParamsTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SubnetParamsTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetParamsContainerImpl(adapter1,bindingPrefix);
