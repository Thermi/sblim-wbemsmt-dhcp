/**
 * SubneteditActionListenerEditBeanSubnetParamsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE
...
public class SubneteditActionListenerEditBeanSubnetParamsTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetParamsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SubneteditActionListenerEditBeanSubnetParamsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPSubnetParamsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.SubneteditActionListenerSelectors.SubnetParamsTabSubnetParamseditPanelSelector();
        selector.select(treeNode, adapter1, "SubnetParamseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPSubnetParamsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SubnetParamsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSubnetParamsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SubnetParamsTab'].");
