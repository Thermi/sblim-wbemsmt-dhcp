/** 
  * PooleditActionListenerEditBeanPoolTab.java
  *
...
public class PooleditActionListenerEditBeanPoolTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['PoolTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolsContainerImpl(adapter1,bindingPrefix);
