/**
 * PooleditActionListenerEditBeanPoolTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class PooleditActionListenerEditBeanPoolTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public PooleditActionListenerEditBeanPoolTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPPoolsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.PooleditActionListenerSelectors.PoolTabPooleditPanelSelector();
        selector.select(treeNode, adapter1, "PooleditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPPoolsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['PoolTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['PoolTab'].");
