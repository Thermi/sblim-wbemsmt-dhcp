/** 
  * PooleditActionListenerEditBeanPoolParamsTab.java
  *
...
public class PooleditActionListenerEditBeanPoolParamsTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['PoolParamsTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolParamsContainerImpl(adapter1,bindingPrefix);
