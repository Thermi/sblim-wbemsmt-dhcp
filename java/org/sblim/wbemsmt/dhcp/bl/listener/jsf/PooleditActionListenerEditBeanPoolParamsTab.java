/**
 * PooleditActionListenerEditBeanPoolParamsTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class PooleditActionListenerEditBeanPoolParamsTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolParamsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public PooleditActionListenerEditBeanPoolParamsTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPPoolParamsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.PooleditActionListenerSelectors.PoolParamsTabPoolParamseditPanelSelector();
        selector.select(treeNode, adapter1, "PoolParamseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPPoolParamsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['PoolParamsTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPPoolParamsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['PoolParamsTab'].");
