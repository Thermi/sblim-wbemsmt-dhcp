/** 
  * SharedneteditActionListenerEditBeanSharednetTab.java
  *
...
public class SharedneteditActionListenerEditBeanSharednetTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SharednetTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednetsContainerImpl(adapter1,bindingPrefix);
