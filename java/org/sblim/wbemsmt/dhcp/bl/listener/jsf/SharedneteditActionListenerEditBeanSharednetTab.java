/**
 * SharedneteditActionListenerEditBeanSharednetTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE
...
public class SharedneteditActionListenerEditBeanSharednetTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednetsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SharedneteditActionListenerEditBeanSharednetTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPSharednetsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.SharedneteditActionListenerSelectors.SharednetTabSharedneteditPanelSelector();
        selector.select(treeNode, adapter1, "SharedneteditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPSharednetsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SharednetTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednetsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SharednetTab'].");
