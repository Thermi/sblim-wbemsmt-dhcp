/**
 * SharedneteditActionListenerEditBeanSharednetOptionTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS
...
public class SharedneteditActionListenerEditBeanSharednetOptionTab extends EditBean {

    private org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednerOptionsContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public SharedneteditActionListenerEditBeanSharednetOptionTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DHCPSharednerOptionsContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector = new org.sblim.wbemsmt.dhcp.bl.listener.SharedneteditActionListenerSelectors.SharednetOptionTabSharednetOptionseditPanelSelector();
        selector.select(treeNode, adapter1, "SharednetOptionseditPanel");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DHCPSharednerOptionsContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['SharednetOptionTab'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednerOptionsContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['SharednetOptionTab'].");
