/** 
  * SharedneteditActionListenerEditBeanSharednetOptionTab.java
  *
...
public class SharedneteditActionListenerEditBeanSharednetOptionTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['SharednetOptionTab'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.dhcp.bl.container.edit.jsf.DHCPSharednerOptionsContainerImpl(adapter1,bindingPrefix);
