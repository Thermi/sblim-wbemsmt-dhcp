/**
 * GroupdeleteActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class GroupdeleteActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.GroupdeleteActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.GroupdeleteActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.GroupdeleteActionListener";
