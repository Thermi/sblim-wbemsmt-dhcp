/**
 * SubneteditActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class SubneteditActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.EditListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.SubneteditActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.SubneteditActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.SubneteditActionListener";
