/**
 * HostcreateActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class HostcreateActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.HostcreateActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.HostcreateActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.HostcreateActionListener";
