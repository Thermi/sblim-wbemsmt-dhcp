/**
 * SharednetdeleteActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class SharednetdeleteActionListener extends TaskLauncherContextMenuEventListenerImpl
        implements org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.SharednetdeleteActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.SharednetdeleteActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.SharednetdeleteActionListener";
