/** 
  * SharednetdeleteActionListener.java
  *
...
public class SharednetdeleteActionListener extends TaskLauncherContextMenuEventListenerImpl implements org.sblim.wbemsmt.tasklauncher.event.DeleteListener {
