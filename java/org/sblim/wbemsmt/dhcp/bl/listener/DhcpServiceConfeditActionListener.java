/**
 * DhcpServiceConfeditActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class DhcpServiceConfeditActionListener extends TaskLauncherContextMenuEventListenerImpl
        implements org.sblim.wbemsmt.tasklauncher.event.EditListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.DhcpServiceConfeditActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.DhcpServiceConfeditActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.DhcpServiceConfeditActionListener";
