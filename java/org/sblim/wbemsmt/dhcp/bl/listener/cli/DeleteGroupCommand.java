...
public class DeleteGroupCommand extends CimCommand {
 ...
 CommandLine cmd = null;
	...
	public DeleteGroupCommand(java.util.Locale locale)
	{
		super("DeleteGroupCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("deleting",new Object[]{bundle.getString("DHCPGroupsContainer.caption")}));
			
			CliDataLoader loader = new DeleteGroupCommandLoader();
			...
			{
    			adapter.delete();
    			values.getOut().println("\n" + bundle.getString("deleted",new Object[]{bundle.getString("DHCPGroupsContainer.caption")}));
			}
			else
			{
    			values.getOut().println("\n" + bundle.getString("not.deleted",new Object[]{bundle.getString("DHCPGroupsContainer.caption")}));
			}
