/**
 * CreateHostCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class CreateHostCommand extends CimCommand implements ContainerUpdater {
    ...
    public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null, "CreateIn",
            null, "CreateHostCommand.CreateIn.argValue", true, false,
            "CreateHostCommand.CreateIn.argDescription");
    /**
     * required,  --name
     */
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "NewHostContainer.Name.argValue", true, false, "NewHostContainer.Name.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewHostWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewHostWizard(
            ...
            while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName())) {
                ...
                if (true == false)
                    ;
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostContainer) dataContainer);
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostSummaryContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostSummaryContainer) dataContainer);
                else {
            ...
            if (true == false)
                ;
            else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostSummaryContainer)
                ((CreateHostCommandLoader) loader)
                        .loadTracingObject(
                                bundle,
                                adapter,
                                (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostSummaryContainer) lastPanel);
            else {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewHostContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewHostContainerImpl(
                    adapter);
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostContainer dc) throws WbemsmtException {
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostSummaryContainer dc)
