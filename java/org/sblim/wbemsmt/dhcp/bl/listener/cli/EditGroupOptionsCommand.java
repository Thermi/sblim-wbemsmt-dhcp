/**
 * EditGroupOptionsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditGroupOptionsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_domainname = new OptionDefinition(null, "domainname",
            null, "DHCPGroupOptionsContainer.domainname.argValue", false, false,
            "DHCPGroupOptionsContainer.domainname.argDescription");
    /**
     *  --domainnameservers
     */
    public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,
            "domainnameservers", null, "DHCPGroupOptionsContainer.domainnameservers.argValue",
            false, false, "DHCPGroupOptionsContainer.domainnameservers.argDescription");
    /**
     *  --routers
     */
    public static final OptionDefinition KEY_routers = new OptionDefinition(null, "routers", null,
            "DHCPGroupOptionsContainer.routers.argValue", false, false,
            "DHCPGroupOptionsContainer.routers.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_domainname, KEY_domainnameservers, KEY_routers, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPGroupOptionsContainer.caption") }));

            CliDataLoader loader = new EditGroupOptionsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPGroupOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPGroupOptionsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGroupOptionsContainer dc)
