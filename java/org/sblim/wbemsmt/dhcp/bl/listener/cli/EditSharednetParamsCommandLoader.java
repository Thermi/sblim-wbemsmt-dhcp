...
public class EditSharednetParamsCommandLoader extends DhcpServiceLoader implements CliDataLoader {
	...
	protected OptionDefinition getServiceNameKey () {
		return EditSharednetParamsCommand.KEY_GLOBAL_listEntities;
	}
