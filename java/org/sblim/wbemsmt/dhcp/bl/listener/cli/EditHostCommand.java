 ...
 CommandLine cmd = null;
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPHostsContainer.caption")}));
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPHostsContainer.caption")}));
