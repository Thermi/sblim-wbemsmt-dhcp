/**
 * EditHostCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditHostCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "DHCPHostsContainer.Name.argValue", true, false,
            "DHCPHostsContainer.Name.argDescription");
    ...
    public EditHostCommand(java.util.Locale locale) {
        super("EditHostCommand", new String[] { "messages", "messagesDhcp" }, locale);
    }
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPHostsContainer.caption") }));

            CliDataLoader loader = new EditHostCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostsContainer dc) throws WbemsmtException {
    }
