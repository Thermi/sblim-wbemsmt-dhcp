...
public class EditSharednetOptionsCommandLoader extends DhcpServiceLoader implements CliDataLoader {
	...
	protected OptionDefinition getServiceNameKey () {
		return EditSharednetOptionsCommand.KEY_GLOBAL_listEntities;
	}
