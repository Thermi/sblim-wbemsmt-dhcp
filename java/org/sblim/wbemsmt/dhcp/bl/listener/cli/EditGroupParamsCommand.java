...
public class EditGroupParamsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --nextserver
		 */
		public static final OptionDefinition KEY_nextserver = new OptionDefinition(null,"nextserver",null,"DHCPGroupParamsContainer.nextserver.argValue",false,false,"DHCPGroupParamsContainer.nextserver.argDescription");
			/**
   		 *  --filename
		 */
		public static final OptionDefinition KEY_filename = new OptionDefinition(null,"filename",null,"DHCPGroupParamsContainer.filename.argValue",false,false,"DHCPGroupParamsContainer.filename.argDescription");
			/**
   		 *  --maxleasetime
		 */
		public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,"maxleasetime",null,"DHCPGroupParamsContainer.maxleasetime.argValue",false,false,"DHCPGroupParamsContainer.maxleasetime.argDescription");
			/**
   		 *  --defaultleasetime
		 */
		public static final OptionDefinition KEY_defaultleasetime = new OptionDefinition(null,"defaultleasetime",null,"DHCPGroupParamsContainer.defaultleasetime.argValue",false,false,"DHCPGroupParamsContainer.defaultleasetime.argDescription");
 ...
 CommandLine cmd = null;
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPGroupParamsContainer.caption")}));

        	CliDataLoader loader = new EditGroupParamsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPGroupParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPGroupParamsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPGroupParamsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGroupParamsContainer dc) throws WbemSmtException {
    	    				    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGroupParamsContainer dc) throws WbemSmtException {
