...
public class DeleteSharednetCommand extends CimCommand {
 ...
 CommandLine cmd = null;
	...
	public DeleteSharednetCommand(java.util.Locale locale)
	{
		super("DeleteSharednetCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("deleting",new Object[]{bundle.getString("DHCPSharednetsContainer.caption")}));
			
			CliDataLoader loader = new DeleteSharednetCommandLoader();
			...
			{
    			adapter.delete();
    			values.getOut().println("\n" + bundle.getString("deleted",new Object[]{bundle.getString("DHCPSharednetsContainer.caption")}));
			}
			else
			{
    			values.getOut().println("\n" + bundle.getString("not.deleted",new Object[]{bundle.getString("DHCPSharednetsContainer.caption")}));
			}
