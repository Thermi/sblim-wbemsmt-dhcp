/**
 * EditsubnetoptionsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditsubnetoptionsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_subnetmask = new OptionDefinition(null, "subnetmask",
            null, "DHCPSubnetOptionsContainer.subnetmask.argValue", false, false,
            "DHCPSubnetOptionsContainer.subnetmask.argDescription");
    /**
     *  --broadcastaddress
     */
    public static final OptionDefinition KEY_broadcastaddress = new OptionDefinition(null,
            "broadcastaddress", null, "DHCPSubnetOptionsContainer.broadcastaddress.argValue",
            false, false, "DHCPSubnetOptionsContainer.broadcastaddress.argDescription");
    /**
     *  --domainnameservers
     */
    public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,
            "domainnameservers", null, "DHCPSubnetOptionsContainer.domainnameservers.argValue",
            false, false, "DHCPSubnetOptionsContainer.domainnameservers.argDescription");
    /**
     *  --domainname
     */
    public static final OptionDefinition KEY_domainname = new OptionDefinition(null, "domainname",
            null, "DHCPSubnetOptionsContainer.domainname.argValue", false, false,
            "DHCPSubnetOptionsContainer.domainname.argDescription");
    /**
     *  --routers
     */
    public static final OptionDefinition KEY_routers = new OptionDefinition(null, "routers", null,
            "DHCPSubnetOptionsContainer.routers.argValue", false, false,
            "DHCPSubnetOptionsContainer.routers.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_subnetmask, KEY_broadcastaddress, KEY_domainnameservers, KEY_domainname,
            KEY_routers, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPSubnetOptionsContainer.caption") }));

            CliDataLoader loader = new EditsubnetoptionsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetOptionsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetOptionsContainer dc)
