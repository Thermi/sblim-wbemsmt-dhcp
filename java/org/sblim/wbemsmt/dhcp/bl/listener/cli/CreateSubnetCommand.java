/**
 * CreateSubnetCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateSubnetCommand extends CimCommand implements ContainerUpdater {
    ...
    public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null, "CreateIn",
            null, "CreateSubnetCommand.CreateIn.argValue", true, false,
            "CreateSubnetCommand.CreateIn.argDescription");
    /**
     * required,  --name
     */
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "NewSubnetContainer.Name.argValue", true, false,
            "NewSubnetContainer.Name.argDescription");
    /**
     *  --netmask
     */
    public static final OptionDefinition KEY_netmask = new OptionDefinition(null, "netmask", null,
            "NewSubnetContainer.Netmask.argValue", false, false,
            "NewSubnetContainer.Netmask.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetWizard(
            ...
            while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName())) {
                ...
                if (true == false)
                    ;
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer) dataContainer);
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer) dataContainer);
                else {
            ...
            if (true == false)
                ;
            else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer)
                ((CreateSubnetCommandLoader) loader)
                        .loadTracingObject(
                                bundle,
                                adapter,
                                (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer) lastPanel);
            else {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetContainerImpl(
                    adapter);
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer dc)
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer dc)
            throws WbemsmtException {
