...
public class CreateSubnetCommand extends CimCommand implements ContainerUpdater {
	...
	//All Options that are local and defined for this command
   		 ...
   		 * required,  --CreateIn
		 */
		public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null,"CreateIn",null,"CreateSubnetCommand.CreateIn.argValue",true,false,"CreateSubnetCommand.CreateIn.argDescription");
			/**
   		 * required,  --name
		 */
		public static final OptionDefinition KEY_name = new OptionDefinition(null,"name",null,"NewSubnetContainer.Name.argValue",true,false,"NewSubnetContainer.Name.argDescription");
			/**
   		 *  --netmask
		 */
		public static final OptionDefinition KEY_netmask = new OptionDefinition(null,"netmask",null,"NewSubnetContainer.Netmask.argValue",false,false,"NewSubnetContainer.Netmask.argDescription");
 ...
 CommandLine cmd = null;
	...
	public CreateSubnetCommand(java.util.Locale locale)
	{
		super("CreateSubnetCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("NewSubnetWizard.create.start"));
			
			CliDataLoader loader = new CreateSubnetCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetWizard((org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter) adapter);
			...
			while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName()))
			{
				...
				if (true == false);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer)dataContainer);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer)dataContainer);
								else {
			...
			if (true == false);
						else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer) ((CreateSubnetCommandLoader)loader).loadTracingObject(bundle,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer)lastPanel);
						else {
				logger.severe("Cannot loadTracingObject for " + lastPanel.getClass().getName());
				throw new WbemSmtException(bundle.getString("internal.error"));
			}
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSubnetContainerImpl(adapter);
			...
			dc.trace(values.getOut());
   		    ...
   		    //values.getOut().println("\n" + bundle.getString("NewSubnetWizard.create.success"));
	...
	{
		if (true == false);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer)dataContainer);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer)dataContainer);
				else {
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetContainer dc) throws WbemSmtException {
		//set the values
											setValue(cmd,dc.get_Name(),KEY_name);
																						setValue(cmd,dc.get_Netmask(),KEY_netmask);
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSubnetSummaryContainer dc) throws WbemSmtException {
		//set the values
