/**
 * EditGlobalParamsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditGlobalParamsCommand extends CimCommand {
     ...
     *  --range
     */
    public static final OptionDefinition KEY_range = new OptionDefinition(null, "range", null,
            "DHCPGlobalParamsContainer.range.argValue", false, false,
            "DHCPGlobalParamsContainer.range.argDescription");
    /**
     *  --usehostdeclnames
     */
    public static final OptionDefinition KEY_usehostdeclnames = new OptionDefinition(null,
            "usehostdeclnames", null, "DHCPGlobalParamsContainer.usehostdeclnames.argValue", false,
            false, "DHCPGlobalParamsContainer.usehostdeclnames.argDescription");
    /**
     *  --hardware
     */
    public static final OptionDefinition KEY_hardware = new OptionDefinition(null, "hardware",
            null, "DHCPGlobalParamsContainer.hardware.argValue", false, false,
            "DHCPGlobalParamsContainer.hardware.argDescription");
    /**
     *  --servername
     */
    public static final OptionDefinition KEY_servername = new OptionDefinition(null, "servername",
            null, "DHCPGlobalParamsContainer.servername.argValue", false, false,
            "DHCPGlobalParamsContainer.servername.argDescription");
    /**
     *  --nextserver
     */
    public static final OptionDefinition KEY_nextserver = new OptionDefinition(null, "nextserver",
            null, "DHCPGlobalParamsContainer.nextserver.argValue", false, false,
            "DHCPGlobalParamsContainer.nextserver.argDescription");
    /**
     *  --fixedaddress
     */
    public static final OptionDefinition KEY_fixedaddress = new OptionDefinition(null,
            "fixedaddress", null, "DHCPGlobalParamsContainer.fixedaddress.argValue", false, false,
            "DHCPGlobalParamsContainer.fixedaddress.argDescription");
    /**
     *  --ddnsupdatestyle
     */
    public static final OptionDefinition KEY_ddnsupdatestyle = new OptionDefinition(null,
            "ddnsupdatestyle", null, "DHCPGlobalParamsContainer.ddnsupdatestyle.argValue", false,
            false, "DHCPGlobalParamsContainer.ddnsupdatestyle.argDescription");
    /**
     *  --serveridentifier
     */
    public static final OptionDefinition KEY_serveridentifier = new OptionDefinition(null,
            "serveridentifier", null, "DHCPGlobalParamsContainer.serveridentifier.argValue", false,
            false, "DHCPGlobalParamsContainer.serveridentifier.argDescription");
    /**
     *  --allow
     */
    public static final OptionDefinition KEY_allow = new OptionDefinition(null, "allow", null,
            "DHCPGlobalParamsContainer.allow.argValue", false, false,
            "DHCPGlobalParamsContainer.allow.argDescription");
    /**
     *  --allowmembersof
     */
    public static final OptionDefinition KEY_allowmembersof = new OptionDefinition(null,
            "allowmembersof", null, "DHCPGlobalParamsContainer.allowmembersof.argValue", false,
            false, "DHCPGlobalParamsContainer.allowmembersof.argDescription");
    /**
     *  --deny
     */
    public static final OptionDefinition KEY_deny = new OptionDefinition(null, "deny", null,
            "DHCPGlobalParamsContainer.deny.argValue", false, false,
            "DHCPGlobalParamsContainer.deny.argDescription");
    /**
     *  --denymembersof
     */
    public static final OptionDefinition KEY_denymembersof = new OptionDefinition(null,
            "denymembersof", null, "DHCPGlobalParamsContainer.denymembersof.argValue", false,
            false, "DHCPGlobalParamsContainer.denymembersof.argDescription");
    /**
     *  --defaultleasetime
     */
    public static final OptionDefinition KEY_defaultleasetime = new OptionDefinition(null,
            "defaultleasetime", null, "DHCPGlobalParamsContainer.defaultleasetime.argValue", false,
            false, "DHCPGlobalParamsContainer.defaultleasetime.argDescription");
    /**
     *  --maxleasetime
     */
    public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,
            "maxleasetime", null, "DHCPGlobalParamsContainer.maxleasetime.argValue", false, false,
            "DHCPGlobalParamsContainer.maxleasetime.argDescription");
    /**
     *  --getleasehostnames
     */
    public static final OptionDefinition KEY_getleasehostnames = new OptionDefinition(null,
            "getleasehostnames", null, "DHCPGlobalParamsContainer.getleasehostnames.argValue",
            false, false, "DHCPGlobalParamsContainer.getleasehostnames.argDescription");
    /**
     *  --dynamicbootpleaselength
     */
    public static final OptionDefinition KEY_dynamicbootpleaselength = new OptionDefinition(null,
            "dynamicbootpleaselength", null,
            "DHCPGlobalParamsContainer.dynamicbootpleaselength.argValue", false, false,
            "DHCPGlobalParamsContainer.dynamicbootpleaselength.argDescription");
    /**
     *  --bootunknownclients
     */
    public static final OptionDefinition KEY_bootunknownclients = new OptionDefinition(null,
            "bootunknownclients", null, "DHCPGlobalParamsContainer.bootunknownclients.argValue",
            false, false, "DHCPGlobalParamsContainer.bootunknownclients.argDescription");
    /**
     *  --leaselimit
     */
    public static final OptionDefinition KEY_leaselimit = new OptionDefinition(null, "leaselimit",
            null, "DHCPGlobalParamsContainer.leaselimit.argValue", false, false,
            "DHCPGlobalParamsContainer.leaselimit.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_range,
            KEY_usehostdeclnames, KEY_hardware, KEY_servername, KEY_nextserver, KEY_fixedaddress,
            KEY_ddnsupdatestyle, KEY_serveridentifier, KEY_allow, KEY_allowmembersof, KEY_deny,
            KEY_denymembersof, KEY_defaultleasetime, KEY_maxleasetime, KEY_getleasehostnames,
            KEY_dynamicbootpleaselength, KEY_bootunknownclients, KEY_leaselimit, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPGlobalParamsContainer.caption") }));

            CliDataLoader loader = new EditGlobalParamsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPGlobalParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPGlobalParamsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGlobalParamsContainer dc)
