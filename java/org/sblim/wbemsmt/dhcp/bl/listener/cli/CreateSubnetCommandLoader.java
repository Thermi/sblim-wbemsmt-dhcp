...
public class CreateSubnetCommandLoader extends DhcpServiceLoader implements CliDataLoader {

	public void loadTracingObject ( WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, NewSubnetSummaryContainer container ) throws ObjectNotFoundException {
		try {
	...
	protected OptionDefinition getServiceNameKey () {
		return CreateSubnetCommand.KEY_GLOBAL_listEntities;
	}
