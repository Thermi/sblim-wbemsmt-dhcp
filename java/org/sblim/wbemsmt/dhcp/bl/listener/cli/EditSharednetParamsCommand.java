/** 
  * EditSharednetParamsCommand.java
  *
...
public class EditSharednetParamsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --maxleasetime
		 */
		public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,"maxleasetime",null,"DHCPSharednetParamsContainer.maxleasetime.argValue",false,false,"DHCPSharednetParamsContainer.maxleasetime.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditSharednetParamsCommand(java.util.Locale locale)
	{
		super("EditSharednetParamsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPSharednetParamsContainer.caption")}));

        	CliDataLoader loader = new EditSharednetParamsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetParamsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPSharednetParamsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetParamsContainer dc) throws WbemSmtException {
    	    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetParamsContainer dc) throws WbemSmtException {
