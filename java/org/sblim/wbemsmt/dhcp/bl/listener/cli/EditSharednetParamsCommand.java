/**
 * EditSharednetParamsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditSharednetParamsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,
            "maxleasetime", null, "DHCPSharednetParamsContainer.maxleasetime.argValue", false,
            false, "DHCPSharednetParamsContainer.maxleasetime.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_maxleasetime, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPSharednetParamsContainer.caption") }));

            CliDataLoader loader = new EditSharednetParamsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetParamsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetParamsContainer dc)
