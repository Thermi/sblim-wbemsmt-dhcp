...
public class DeleteSubnetCommand extends CimCommand {
 ...
 CommandLine cmd = null;
	...
	public DeleteSubnetCommand(java.util.Locale locale)
	{
		super("DeleteSubnetCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("deleting",new Object[]{bundle.getString("DHCPSubnetsContainer.caption")}));
			
			CliDataLoader loader = new DeleteSubnetCommandLoader();
			...
			{
    			adapter.delete();
    			values.getOut().println("\n" + bundle.getString("deleted",new Object[]{bundle.getString("DHCPSubnetsContainer.caption")}));
			}
			else
			{
    			values.getOut().println("\n" + bundle.getString("not.deleted",new Object[]{bundle.getString("DHCPSubnetsContainer.caption")}));
			}
