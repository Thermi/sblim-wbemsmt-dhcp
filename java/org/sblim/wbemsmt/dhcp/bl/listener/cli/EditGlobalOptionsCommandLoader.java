...
public class EditGlobalOptionsCommandLoader extends DhcpServiceLoader implements CliDataLoader {

	protected OptionDefinition getServiceNameKey () {
		return EditGlobalOptionsCommand.KEY_GLOBAL_serviceName;
	}

	protected String getEntityType () {
		return ClassUtils.getShortClassName(Linux_DHCPService.class);
	}
