...
public class EditSubnetCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 * required,  --name
		 */
		public static final OptionDefinition KEY_name = new OptionDefinition(null,"name",null,"DHCPSubnetsContainer.Name.argValue",true,false,"DHCPSubnetsContainer.Name.argDescription");
			/**
   		 * required,  --netmask
		 */
		public static final OptionDefinition KEY_netmask = new OptionDefinition(null,"netmask",null,"DHCPSubnetsContainer.Netmask.argValue",true,false,"DHCPSubnetsContainer.Netmask.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditSubnetCommand(java.util.Locale locale)
	{
		super("EditSubnetCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPSubnetsContainer.caption")}));

        	CliDataLoader loader = new EditSubnetCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPSubnetsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetsContainer dc) throws WbemSmtException {
    	    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetsContainer dc) throws WbemSmtException {
