/**
 * EditSubnetCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditSubnetCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "DHCPSubnetsContainer.Name.argValue", true, false,
            "DHCPSubnetsContainer.Name.argDescription");
    /**
     * required,  --netmask
     */
    public static final OptionDefinition KEY_netmask = new OptionDefinition(null, "netmask", null,
            "DHCPSubnetsContainer.Netmask.argValue", true, false,
            "DHCPSubnetsContainer.Netmask.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPSubnetsContainer.caption") }));

            CliDataLoader loader = new EditSubnetCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetsContainer dc)
