/**
 * EditPoolCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditPoolCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "DHCPPoolsContainer.Name.argValue", false, false,
            "DHCPPoolsContainer.Name.argDescription");
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolsContainer dc) throws WbemsmtException {
    }
