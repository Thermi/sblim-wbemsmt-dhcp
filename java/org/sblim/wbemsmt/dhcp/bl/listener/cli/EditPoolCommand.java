...
public class EditPoolCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --name
		 */
		public static final OptionDefinition KEY_name = new OptionDefinition(null,"name",null,"DHCPPoolsContainer.Name.argValue",false,false,"DHCPPoolsContainer.Name.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditPoolCommand(java.util.Locale locale)
	{
		super("EditPoolCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPPoolsContainer.caption")}));

        	CliDataLoader loader = new EditPoolCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPPoolsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolsContainer dc) throws WbemSmtException {
    	    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolsContainer dc) throws WbemSmtException {
