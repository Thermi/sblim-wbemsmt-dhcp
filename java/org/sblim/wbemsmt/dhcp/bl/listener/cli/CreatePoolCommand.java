...
public class CreatePoolCommand extends CimCommand implements ContainerUpdater {
	...
	//All Options that are local and defined for this command
   		 ...
   		 * required,  --CreateIn
		 */
		public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null,"CreateIn",null,"CreatePoolCommand.CreateIn.argValue",true,false,"CreatePoolCommand.CreateIn.argDescription");
			/**
   		 * required,  --name
		 */
		public static final OptionDefinition KEY_name = new OptionDefinition(null,"name",null,"NewPoolContainer.Name.argValue",true,false,"NewPoolContainer.Name.argDescription");
			/**
   		 * required,  --range
		 */
		public static final OptionDefinition KEY_range = new OptionDefinition(null,"range",null,"NewPoolContainer.range.argValue",true,false,"NewPoolContainer.range.argDescription");
 ...
 CommandLine cmd = null;
	...
	public CreatePoolCommand(java.util.Locale locale)
	{
		super("CreatePoolCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("NewPoolWizard.create.start"));
			
			CliDataLoader loader = new CreatePoolCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolWizard((org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter) adapter);
			...
			while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName()))
			{
				...
				if (true == false);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer)dataContainer);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer)dataContainer);
								else {
			...
			if (true == false);
						else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer) ((CreatePoolCommandLoader)loader).loadTracingObject(bundle,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer)lastPanel);
						else {
				logger.severe("Cannot loadTracingObject for " + lastPanel.getClass().getName());
				throw new WbemSmtException(bundle.getString("internal.error"));
			}
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolContainerImpl(adapter);
			...
			dc.trace(values.getOut());
   		    ...
   		    //values.getOut().println("\n" + bundle.getString("NewPoolWizard.create.success"));
	...
	{
		if (true == false);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer)dataContainer);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer)dataContainer);
				else {
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer dc) throws WbemSmtException {
		//set the values
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer dc) throws WbemSmtException {
		//set the values
