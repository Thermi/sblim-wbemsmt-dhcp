/**
 * CreatePoolCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class CreatePoolCommand extends CimCommand implements ContainerUpdater {
    ...
    public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null, "CreateIn",
            null, "CreatePoolCommand.CreateIn.argValue", true, false,
            "CreatePoolCommand.CreateIn.argDescription");
    /**
     * required,  --name
     */
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "NewPoolContainer.Name.argValue", true, false, "NewPoolContainer.Name.argDescription");
    /**
     * required,  --range
     */
    public static final OptionDefinition KEY_range = new OptionDefinition(null, "range", null,
            "NewPoolContainer.range.argValue", true, false, "NewPoolContainer.range.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolWizard(
            ...
            while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName())) {
                ...
                if (true == false)
                    ;
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer) dataContainer);
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer) dataContainer);
                else {
            ...
            if (true == false)
                ;
            else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer)
                ((CreatePoolCommandLoader) loader)
                        .loadTracingObject(
                                bundle,
                                adapter,
                                (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer) lastPanel);
            else {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewPoolContainerImpl(
                    adapter);
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolContainer dc) throws WbemsmtException {
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer dc)
