...
public class CreateSharednetCommand extends CimCommand implements ContainerUpdater {
	...
	//All Options that are local and defined for this command
   		 ...
   		 * required,  --CreateIn
		 */
		public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null,"CreateIn",null,"CreateSharednetCommand.CreateIn.argValue",true,false,"CreateSharednetCommand.CreateIn.argDescription");
			/**
   		 * required,  --name
		 */
		public static final OptionDefinition KEY_name = new OptionDefinition(null,"name",null,"NewSharednetContainer.Name.argValue",true,false,"NewSharednetContainer.Name.argDescription");
 ...
 CommandLine cmd = null;
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSharednetWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSharednetWizard((org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter) adapter);
			...
			while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName()))
			{
				...
				if (true == false);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetContainer)dataContainer);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer)dataContainer);
								else {
			...
			if (true == false);
						else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer) ((CreateSharednetCommandLoader)loader).loadTracingObject(bundle,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer)lastPanel);
						else {
				logger.severe("Cannot loadTracingObject for " + lastPanel.getClass().getName());
				throw new WbemSmtException(bundle.getString("internal.error"));
			}
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSharednetContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewSharednetContainerImpl(adapter);
	...
	{
		if (true == false);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetContainer)dataContainer);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer)dataContainer);
				else {
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetContainer dc) throws WbemSmtException {
		//set the values
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewSharednetSummaryContainer dc) throws WbemSmtException {
		//set the values
