/**
 * EditSubnetParamsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditSubnetParamsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_range = new OptionDefinition(null, "range", null,
            "DHCPSubnetParamsContainer.range.argValue", false, false,
            "DHCPSubnetParamsContainer.range.argDescription");
    /**
     *  --defaultleasetime
     */
    public static final OptionDefinition KEY_defaultleasetime = new OptionDefinition(null,
            "defaultleasetime", null, "DHCPSubnetParamsContainer.defaultleasetime.argValue", false,
            false, "DHCPSubnetParamsContainer.defaultleasetime.argDescription");
    /**
     *  --maxleasetime
     */
    public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,
            "maxleasetime", null, "DHCPSubnetParamsContainer.maxleasetime.argValue", false, false,
            "DHCPSubnetParamsContainer.maxleasetime.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_range,
            KEY_defaultleasetime, KEY_maxleasetime, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPSubnetParamsContainer.caption") }));

            CliDataLoader loader = new EditSubnetParamsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetParamsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetParamsContainer dc)
