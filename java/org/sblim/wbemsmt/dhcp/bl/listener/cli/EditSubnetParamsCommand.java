...
public class EditSubnetParamsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --range
		 */
		public static final OptionDefinition KEY_range = new OptionDefinition(null,"range",null,"DHCPSubnetParamsContainer.range.argValue",false,false,"DHCPSubnetParamsContainer.range.argDescription");
			/**
   		 *  --defaultleasetime
		 */
		public static final OptionDefinition KEY_defaultleasetime = new OptionDefinition(null,"defaultleasetime",null,"DHCPSubnetParamsContainer.defaultleasetime.argValue",false,false,"DHCPSubnetParamsContainer.defaultleasetime.argDescription");
			/**
   		 *  --maxleasetime
		 */
		public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,"maxleasetime",null,"DHCPSubnetParamsContainer.maxleasetime.argValue",false,false,"DHCPSubnetParamsContainer.maxleasetime.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditSubnetParamsCommand(java.util.Locale locale)
	{
		super("EditSubnetParamsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPSubnetParamsContainer.caption")}));

        	CliDataLoader loader = new EditSubnetParamsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSubnetParamsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPSubnetParamsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetParamsContainer dc) throws WbemSmtException {
    	    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetParamsContainer dc) throws WbemSmtException {
