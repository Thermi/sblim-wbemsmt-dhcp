/** 
  * EditSharednetOptionsCommand.java
  *
...
public class EditSharednetOptionsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --domainnameservers
		 */
		public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,"domainnameservers",null,"DHCPSharednerOptionsContainer.domainnameservers.argValue",false,false,"DHCPSharednerOptionsContainer.domainnameservers.argDescription");
			/**
   		 *  --domainname
		 */
		public static final OptionDefinition KEY_domainname = new OptionDefinition(null,"domainname",null,"DHCPSharednerOptionsContainer.domainname.argValue",false,false,"DHCPSharednerOptionsContainer.domainname.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditSharednetOptionsCommand(java.util.Locale locale)
	{
		super("EditSharednetOptionsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPSharednerOptionsContainer.caption")}));

        	CliDataLoader loader = new EditSharednetOptionsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednerOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednerOptionsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPSharednerOptionsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednerOptionsContainer dc) throws WbemSmtException {
    	    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednerOptionsContainer dc) throws WbemSmtException {
