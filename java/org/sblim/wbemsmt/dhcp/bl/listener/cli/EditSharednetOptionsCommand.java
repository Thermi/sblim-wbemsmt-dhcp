/**
 * EditSharednetOptionsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditSharednetOptionsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,
            "domainnameservers", null, "DHCPSharednerOptionsContainer.domainnameservers.argValue",
            false, false, "DHCPSharednerOptionsContainer.domainnameservers.argDescription");
    /**
     *  --domainname
     */
    public static final OptionDefinition KEY_domainname = new OptionDefinition(null, "domainname",
            null, "DHCPSharednerOptionsContainer.domainname.argValue", false, false,
            "DHCPSharednerOptionsContainer.domainname.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_domainnameservers, KEY_domainname, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPSharednerOptionsContainer.caption") }));

            CliDataLoader loader = new EditSharednetOptionsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednerOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednerOptionsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednerOptionsContainer dc)
