...
public class CreatePoolCommandLoader extends DhcpServiceLoader implements CliDataLoader {
	...
	public void loadTracingObject ( WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, NewPoolSummaryContainer container ) throws ObjectNotFoundException {
		try {
