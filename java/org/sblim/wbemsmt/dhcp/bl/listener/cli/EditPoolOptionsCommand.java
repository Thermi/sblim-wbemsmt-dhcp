...
public class EditPoolOptionsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --domainnameservers
		 */
		public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,"domainnameservers",null,"DHCPPoolOptionsContainer.domainnameservers.argValue",false,false,"DHCPPoolOptionsContainer.domainnameservers.argDescription");
			/**
   		 *  --domainname
		 */
		public static final OptionDefinition KEY_domainname = new OptionDefinition(null,"domainname",null,"DHCPPoolOptionsContainer.domainname.argValue",false,false,"DHCPPoolOptionsContainer.domainname.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditPoolOptionsCommand(java.util.Locale locale)
	{
		super("EditPoolOptionsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPPoolOptionsContainer.caption")}));

        	CliDataLoader loader = new EditPoolOptionsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolOptionsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPPoolOptionsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolOptionsContainer dc) throws WbemSmtException {
    	    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolOptionsContainer dc) throws WbemSmtException {
