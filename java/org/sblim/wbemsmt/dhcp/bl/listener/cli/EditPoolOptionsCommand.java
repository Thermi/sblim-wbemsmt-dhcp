/**
 * EditPoolOptionsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditPoolOptionsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,
            "domainnameservers", null, "DHCPPoolOptionsContainer.domainnameservers.argValue",
            false, false, "DHCPPoolOptionsContainer.domainnameservers.argDescription");
    /**
     *  --domainname
     */
    public static final OptionDefinition KEY_domainname = new OptionDefinition(null, "domainname",
            null, "DHCPPoolOptionsContainer.domainname.argValue", false, false,
            "DHCPPoolOptionsContainer.domainname.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPPoolOptionsContainer.caption") }));

            CliDataLoader loader = new EditPoolOptionsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolOptionsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolOptionsContainer dc)
