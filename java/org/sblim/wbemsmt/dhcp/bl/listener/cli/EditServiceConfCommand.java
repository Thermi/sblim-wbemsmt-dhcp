...
public class EditServiceConfCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_configurationFile = new OptionDefinition(null,"configurationFile",null,"DhcpServiceConfContainer.ConfigurationFile.argValue",true,false,"DhcpServiceConfContainer.ConfigurationFile.argDescription");
			/**
   		 *  --startService
		 */
		public static final OptionDefinition KEY_startService = new OptionDefinition(null,"startService",null,"DhcpServiceConfContainer.startService.argValue",false,false,"DhcpServiceConfContainer.startService.argDescription");
			/**
   		 *  --stopService
		 */
		public static final OptionDefinition KEY_stopService = new OptionDefinition(null,"stopService",null,"DhcpServiceConfContainer.stopService.argValue",false,false,"DhcpServiceConfContainer.stopService.argDescription");
			/**
   		 *  --restartService
		 */
		public static final OptionDefinition KEY_restartService = new OptionDefinition(null,"restartService",null,null,false,false,"DhcpServiceConfContainer.restartservice.argDescription");
 ...
 CommandLine cmd = null;
	...
	{
		super("EditServiceConfCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DhcpServiceConfContainer.caption")}));

        	CliDataLoader loader = new EditServiceConfCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DhcpServiceConfContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DhcpServiceConfContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DhcpServiceConfContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DhcpServiceConfContainer dc) throws WbemSmtException {
    	    				    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DhcpServiceConfContainer dc) throws WbemSmtException {
    										setValue(cmd,dc.get_ConfigurationFile(),KEY_configurationFile);
																																																												
		//The Buttons
    																			if (!pressButton(cmd,adapter,dc,dc.get_invoke_StartService(),KEY_startService)) return;
																if (!pressButton(cmd,adapter,dc,dc.get_invoke_StopService(),KEY_stopService)) return;
																if (!pressButton(cmd,adapter,dc,dc.get_usr_Restartservice(),KEY_restartService)) return;
								}	
