...
public class EditServiceConfCommand extends CimCommand {
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DhcpServiceConfContainer.caption") }));

            CliDataLoader loader = new EditServiceConfCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DhcpServiceConfContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DhcpServiceConfContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DhcpServiceConfContainer dc)
