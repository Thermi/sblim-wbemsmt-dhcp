/**
 * CreateGroupCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateGroupCommand extends CimCommand implements ContainerUpdater {
    ...
    public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null, "CreateIn",
            null, "CreateGroupCommand.CreateIn.argValue", true, false,
            "CreateGroupCommand.CreateIn.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupWizard(
            ...
            while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName())) {
                ...
                if (true == false)
                    ;
                else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer) dataContainer);
                else {
            ...
            if (true == false)
                ;
            else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer)
                ((CreateGroupCommandLoader) loader).loadTracingObject(bundle, adapter,
                        (org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer) lastPanel);
            else {
            ...
            org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupContainerImpl(
                    adapter);
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer dc)
