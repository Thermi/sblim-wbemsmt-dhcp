...
public class CreateGroupCommand extends CimCommand implements ContainerUpdater {
	...
	//All Options that are local and defined for this command
   		 ...
   		 * required,  --CreateIn
		 */
		public static final OptionDefinition KEY_CreateIn = new OptionDefinition(null,"CreateIn",null,"CreateGroupCommand.CreateIn.argValue",true,false,"CreateGroupCommand.CreateIn.argDescription");
 ...
 CommandLine cmd = null;
	...
	public CreateGroupCommand(java.util.Locale locale)
	{
		super("CreateGroupCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("NewGroupWizard.create.start"));
			
			CliDataLoader loader = new CreateGroupCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupWizard wizard = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupWizard((org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter) adapter);
			...
			while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName()))
			{
				...
				if (true == false);
								else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer) setCommandLineValues(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer)dataContainer);
								else {
			...
			if (true == false);
						else if (lastPanel instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer) ((CreateGroupCommandLoader)loader).loadTracingObject(bundle,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer)lastPanel);
						else {
				logger.severe("Cannot loadTracingObject for " + lastPanel.getClass().getName());
				throw new WbemSmtException(bundle.getString("internal.error"));
			}
			
			org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.wizard.cli.NewGroupContainerImpl(adapter);
			...
			dc.trace(values.getOut());
   		    ...
   		    //values.getOut().println("\n" + bundle.getString("NewGroupWizard.create.success"));
	...
	{
		if (true == false);
				else if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer) updateContainerChilds(cmd,adapter,(org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer)dataContainer);
				else {
	...
	private void updateContainerChilds(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer dc) throws UpdateControlsException {
	...
	private void setCommandLineValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.wizard.NewGroupContainer dc) throws WbemSmtException {
		//set the values
