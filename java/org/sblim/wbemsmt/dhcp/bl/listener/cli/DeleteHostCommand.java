...
public class DeleteHostCommand extends CimCommand {
 ...
 CommandLine cmd = null;
	...
	public DeleteHostCommand(java.util.Locale locale)
	{
		super("DeleteHostCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("deleting",new Object[]{bundle.getString("DHCPHostsContainer.caption")}));
			
			CliDataLoader loader = new DeleteHostCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostsContainerImpl(adapter);
			...
			{
    			adapter.delete();
    			values.getOut().println("\n" + bundle.getString("deleted",new Object[]{bundle.getString("DHCPHostsContainer.caption")}));
			}
			else
			{
    			values.getOut().println("\n" + bundle.getString("not.deleted",new Object[]{bundle.getString("DHCPHostsContainer.caption")}));
			}
