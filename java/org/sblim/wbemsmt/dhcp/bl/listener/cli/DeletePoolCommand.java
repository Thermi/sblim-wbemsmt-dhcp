 ...
 CommandLine cmd = null;
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("deleting",new Object[]{bundle.getString("DHCPPoolsContainer.caption")}));
			...
			{
    			adapter.delete();
    			values.getOut().println("\n" + bundle.getString("deleted",new Object[]{bundle.getString("DHCPPoolsContainer.caption")}));
			}
			else
			{
    			values.getOut().println("\n" + bundle.getString("not.deleted",new Object[]{bundle.getString("DHCPPoolsContainer.caption")}));
			}
