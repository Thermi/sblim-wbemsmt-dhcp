/**
 * EditPoolParamsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditPoolParamsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_range = new OptionDefinition(null, "range", null,
            "DHCPPoolParamsContainer.range.argValue", false, false,
            "DHCPPoolParamsContainer.range.argDescription");
    /**
     *  --allow
     */
    public static final OptionDefinition KEY_allow = new OptionDefinition(null, "allow", null,
            "DHCPPoolParamsContainer.allow.argValue", false, false,
            "DHCPPoolParamsContainer.allow.argDescription");
    /**
     *  --allowmembersof
     */
    public static final OptionDefinition KEY_allowmembersof = new OptionDefinition(null,
            "allowmembersof", null, "DHCPPoolParamsContainer.allowmembersof.argValue", false,
            false, "DHCPPoolParamsContainer.allowmembersof.argDescription");
    /**
     *  --deny
     */
    public static final OptionDefinition KEY_deny = new OptionDefinition(null, "deny", null,
            "DHCPPoolParamsContainer.deny.argValue", false, false,
            "DHCPPoolParamsContainer.deny.argDescription");
    /**
     *  --denymembersof
     */
    public static final OptionDefinition KEY_denymembersof = new OptionDefinition(null,
            "denymembersof", null, "DHCPPoolParamsContainer.denymembersof.argValue", false, false,
            "DHCPPoolParamsContainer.denymembersof.argDescription");
    /**
     *  --maxleasetime
     */
    public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,
            "maxleasetime", null, "DHCPPoolParamsContainer.maxleasetime.argValue", false, false,
            "DHCPPoolParamsContainer.maxleasetime.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_range,
            KEY_allow, KEY_allowmembersof, KEY_deny, KEY_denymembersof, KEY_maxleasetime, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPPoolParamsContainer.caption") }));

            CliDataLoader loader = new EditPoolParamsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolParamsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolParamsContainer dc)
