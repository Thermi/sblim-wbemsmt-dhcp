...
public class EditPoolParamsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --range
		 */
		public static final OptionDefinition KEY_range = new OptionDefinition(null,"range",null,"DHCPPoolParamsContainer.range.argValue",false,false,"DHCPPoolParamsContainer.range.argDescription");
			/**
   		 *  --allow
		 */
		public static final OptionDefinition KEY_allow = new OptionDefinition(null,"allow",null,"DHCPPoolParamsContainer.allow.argValue",false,false,"DHCPPoolParamsContainer.allow.argDescription");
			/**
   		 *  --allowmembersof
		 */
		public static final OptionDefinition KEY_allowmembersof = new OptionDefinition(null,"allowmembersof",null,"DHCPPoolParamsContainer.allowmembersof.argValue",false,false,"DHCPPoolParamsContainer.allowmembersof.argDescription");
			/**
   		 *  --deny
		 */
		public static final OptionDefinition KEY_deny = new OptionDefinition(null,"deny",null,"DHCPPoolParamsContainer.deny.argValue",false,false,"DHCPPoolParamsContainer.deny.argDescription");
			/**
   		 *  --denymembersof
		 */
		public static final OptionDefinition KEY_denymembersof = new OptionDefinition(null,"denymembersof",null,"DHCPPoolParamsContainer.denymembersof.argValue",false,false,"DHCPPoolParamsContainer.denymembersof.argDescription");
			/**
   		 *  --maxleasetime
		 */
		public static final OptionDefinition KEY_maxleasetime = new OptionDefinition(null,"maxleasetime",null,"DHCPPoolParamsContainer.maxleasetime.argValue",false,false,"DHCPPoolParamsContainer.maxleasetime.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditPoolParamsCommand(java.util.Locale locale)
	{
		super("EditPoolParamsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPPoolParamsContainer.caption")}));

        	CliDataLoader loader = new EditPoolParamsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPPoolParamsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPPoolParamsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolParamsContainer dc) throws WbemSmtException {
    	    				    				    				    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolParamsContainer dc) throws WbemSmtException {
