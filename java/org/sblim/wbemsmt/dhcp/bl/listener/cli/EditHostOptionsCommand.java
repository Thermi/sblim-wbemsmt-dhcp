/**
 * EditHostOptionsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditHostOptionsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_hostname = new OptionDefinition(null, "hostname",
            null, "DHCPHostOptionsContainer.hostname.argValue", false, false,
            "DHCPHostOptionsContainer.hostname.argDescription");
    /**
     *  --domainnameservers
     */
    public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,
            "domainnameservers", null, "DHCPHostOptionsContainer.domainnameservers.argValue",
            false, false, "DHCPHostOptionsContainer.domainnameservers.argDescription");
    /**
     *  --domainname
     */
    public static final OptionDefinition KEY_domainname = new OptionDefinition(null, "domainname",
            null, "DHCPHostOptionsContainer.domainname.argValue", false, false,
            "DHCPHostOptionsContainer.domainname.argDescription");
    /**
     *  --dhcpclientidentifier
     */
    public static final OptionDefinition KEY_dhcpclientidentifier = new OptionDefinition(null,
            "dhcpclientidentifier", null, "DHCPHostOptionsContainer.dhcpclientidentifier.argValue",
            false, false, "DHCPHostOptionsContainer.dhcpclientidentifier.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_hostname,
            KEY_domainnameservers, KEY_domainname, KEY_dhcpclientidentifier, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPHostOptionsContainer.caption") }));

            CliDataLoader loader = new EditHostOptionsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostOptionsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostOptionsContainer dc)
