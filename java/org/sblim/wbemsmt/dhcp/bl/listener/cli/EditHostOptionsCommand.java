...
public class EditHostOptionsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --hostname
		 */
		public static final OptionDefinition KEY_hostname = new OptionDefinition(null,"hostname",null,"DHCPHostOptionsContainer.hostname.argValue",false,false,"DHCPHostOptionsContainer.hostname.argDescription");
			/**
   		 *  --domainnameservers
		 */
		public static final OptionDefinition KEY_domainnameservers = new OptionDefinition(null,"domainnameservers",null,"DHCPHostOptionsContainer.domainnameservers.argValue",false,false,"DHCPHostOptionsContainer.domainnameservers.argDescription");
			/**
   		 *  --domainname
		 */
		public static final OptionDefinition KEY_domainname = new OptionDefinition(null,"domainname",null,"DHCPHostOptionsContainer.domainname.argValue",false,false,"DHCPHostOptionsContainer.domainname.argDescription");
			/**
   		 *  --dhcpclientidentifier
		 */
		public static final OptionDefinition KEY_dhcpclientidentifier = new OptionDefinition(null,"dhcpclientidentifier",null,"DHCPHostOptionsContainer.dhcpclientidentifier.argValue",false,false,"DHCPHostOptionsContainer.dhcpclientidentifier.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditHostOptionsCommand(java.util.Locale locale)
	{
		super("EditHostOptionsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPHostOptionsContainer.caption")}));

        	CliDataLoader loader = new EditHostOptionsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostOptionsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostOptionsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPHostOptionsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostOptionsContainer dc) throws WbemSmtException {
    	    				    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostOptionsContainer dc) throws WbemSmtException {
