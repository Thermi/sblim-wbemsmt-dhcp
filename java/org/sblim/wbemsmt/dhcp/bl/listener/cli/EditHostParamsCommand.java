/**
 * EditHostParamsCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditHostParamsCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_range = new OptionDefinition(null, "range", null,
            "DHCPHostParamsContainer.range.argValue", false, false,
            "DHCPHostParamsContainer.range.argDescription");
    /**
     *  --fixedaddress
     */
    public static final OptionDefinition KEY_fixedaddress = new OptionDefinition(null,
            "fixedaddress", null, "DHCPHostParamsContainer.fixedaddress.argValue", false, false,
            "DHCPHostParamsContainer.fixedaddress.argDescription");
    /**
     *  --hardware
     */
    public static final OptionDefinition KEY_hardware = new OptionDefinition(null, "hardware",
            null, "DHCPHostParamsContainer.hardware.argValue", false, false,
            "DHCPHostParamsContainer.hardware.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPHostParamsContainer.caption") }));

            CliDataLoader loader = new EditHostParamsCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostParamsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostParamsContainer dc)
