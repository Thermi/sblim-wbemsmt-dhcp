...
public class EditHostParamsCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --range
		 */
		public static final OptionDefinition KEY_range = new OptionDefinition(null,"range",null,"DHCPHostParamsContainer.range.argValue",false,false,"DHCPHostParamsContainer.range.argDescription");
			/**
   		 *  --fixedaddress
		 */
		public static final OptionDefinition KEY_fixedaddress = new OptionDefinition(null,"fixedaddress",null,"DHCPHostParamsContainer.fixedaddress.argValue",false,false,"DHCPHostParamsContainer.fixedaddress.argDescription");
			/**
   		 *  --hardware
		 */
		public static final OptionDefinition KEY_hardware = new OptionDefinition(null,"hardware",null,"DHCPHostParamsContainer.hardware.argValue",false,false,"DHCPHostParamsContainer.hardware.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditHostParamsCommand(java.util.Locale locale)
	{
		super("EditHostParamsCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPHostParamsContainer.caption")}));

        	CliDataLoader loader = new EditHostParamsCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostParamsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPHostParamsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPHostParamsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostParamsContainer dc) throws WbemSmtException {
    	    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostParamsContainer dc) throws WbemSmtException {
