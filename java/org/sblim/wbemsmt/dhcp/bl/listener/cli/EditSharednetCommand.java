/**
 * EditSharednetCommand.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class EditSharednetCommand extends CimCommand {
    ...
    public static final OptionDefinition KEY_name = new OptionDefinition(null, "name", null,
            "DHCPSharednetsContainer.Name.argValue", false, false,
            "DHCPSharednetsContainer.Name.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DHCPSharednetsContainer.caption") }));

            CliDataLoader loader = new EditSharednetCommandLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetsContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetsContainer dc)
