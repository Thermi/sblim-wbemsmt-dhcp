...
public class EditSharednetCommand extends CimCommand {
	...
	//All Options that are local and defined for this command
   		 ...
   		 *  --name
		 */
		public static final OptionDefinition KEY_name = new OptionDefinition(null,"name",null,"DHCPSharednetsContainer.Name.argValue",false,false,"DHCPSharednetsContainer.Name.argDescription");
 ...
 CommandLine cmd = null;
	...
	public EditSharednetCommand(java.util.Locale locale)
	{
		super("EditSharednetCommand", new String[]{"messages","messagesDhcp"},locale);
	}
	...
	public void execute(CimCommandValues values) throws WbemSmtException {
		...
		try {
			...
			values.getOut().println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DHCPSharednetsContainer.caption")}));

        	CliDataLoader loader = new EditSharednetCommandLoader();
			loader.load(bundle,adapter, commandValues);
			
			org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetsContainerImpl dc = new org.sblim.wbemsmt.dhcp.bl.container.edit.cli.DHCPSharednetsContainerImpl(adapter);
			...
			values.getOut().println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DHCPSharednetsContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetsContainer dc) throws WbemSmtException {
    	    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetsContainer dc) throws WbemSmtException {
