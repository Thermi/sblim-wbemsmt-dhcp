/**
 * GroupeditActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class GroupeditActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.EditListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.GroupeditActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.GroupeditActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.GroupeditActionListener";
