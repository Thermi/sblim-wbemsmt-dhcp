...
public class SubnetcreateActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.SubnetcreateActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.SubnetcreateActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.SubnetcreateActionListener";
