/** 
  * SubnetdeleteActionListener.java
  *
...
public class SubnetdeleteActionListener extends TaskLauncherContextMenuEventListenerImpl implements org.sblim.wbemsmt.tasklauncher.event.DeleteListener {
