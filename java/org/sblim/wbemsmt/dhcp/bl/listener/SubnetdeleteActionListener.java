/**
 * SubnetdeleteActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class SubnetdeleteActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.SubnetdeleteActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.SubnetdeleteActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.SubnetdeleteActionListener";
