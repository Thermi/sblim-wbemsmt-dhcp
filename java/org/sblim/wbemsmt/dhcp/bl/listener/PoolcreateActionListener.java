/**
 * PoolcreateActionListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class PoolcreateActionListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.dhcp.bl.listener.jsf.PoolcreateActionListener";
    String swingListener = "org.sblim.wbemsmt.dhcp.bl.listener.jswing.PoolcreateActionListener";

    //String cmdListener = "org.sblim.wbemsmt.dhcp.bl.listener.cli.PoolcreateActionListener";
