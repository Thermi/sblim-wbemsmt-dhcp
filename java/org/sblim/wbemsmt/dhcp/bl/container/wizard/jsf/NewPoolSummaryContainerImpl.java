...
public class NewPoolSummaryContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.wizard.NewPoolSummaryContainer {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_Name;
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_Range;

    public NewPoolSummaryContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "NewPoolSummaryContainer.caption",
                "NewPoolSummaryContainer.subTitle", false);
