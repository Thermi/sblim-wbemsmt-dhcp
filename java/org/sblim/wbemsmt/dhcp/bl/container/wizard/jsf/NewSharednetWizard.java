...
public class NewSharednetWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    public NewSharednetWizard(final org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "NewSharednetWizard.title");
        ...
        this.container = new org.sblim.wbemsmt.dhcp.wizard.NewSharednetWizardContainer(adapter,
                new org.sblim.wbemsmt.dhcp.wizard.NewSharednetWizardContainerPanels() {
                    ...
                    public DataContainer getNewSharednet() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSharednetContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard NewSharednetWizard", e);
                        }
                    }
                    ...
                    public DataContainer getNewSharednetSummary() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSharednetSummaryContainerImpl(
                                    adapter, binding);
    ...
    public String getFinishText() {
        return bundle.getString("NewSharednetWizard.finishText", bundle
                .getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("NewSharednetWizard.createWaitText", bundle
