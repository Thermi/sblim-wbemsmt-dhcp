...
public class NewSubnetWizard extends JSFWizardBase implements IPageWizardAdapter {
	...
	String binding = "objectActionController.currentWizard.currentPanel.";
		...
		org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetContainerImpl panel1 = null;
		org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetSummaryContainerImpl panel2 = null;
	...
	public NewSubnetWizard(final org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter) {
		super(adapter,ResourceBundleManager.getResourceBundle(new String[]{"messages","messagesDhcp"},LocaleManager.getCurrent(FacesContext.getCurrentInstance()).getCurrentLocale()),"NewSubnetWizard.title");
		...
		this.container = new org.sblim.wbemsmt.dhcp.wizard.NewSubnetWizardContainer (adapter,new org.sblim.wbemsmt.dhcp.wizard.NewSubnetWizardContainerPanels()
 			{
					...
					public Object getNewSubnet() throws WbemSmtException
					{
						...
						try
						{
    						panel1= new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetContainerImpl(adapter,binding);
						...
						{
							throw new WbemSmtException("Cannot process Wizard NewSubnetWizard",e);
						}
    				}
            						//update the child objects
					...
					public Object getNewSubnetSummary() throws WbemSmtException
					{
						...
						try
						{
    						panel2= new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetSummaryContainerImpl(adapter,binding);
   ...
   //Workaround for a bug within myFaces - Everytime a new panel is created the childs are created also
	...
	public void countAndCreateChilds(DataContainer dataContainer) throws UpdateControlsException {
            						if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetContainerImpl)
					{
        				    					//update the child objects
        										try
						{
						...
						{
							throw new UpdateControlsException("Cannot process Wizard NewSubnetWizard",e);
						}
    				}
            						if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetSummaryContainerImpl)
					{
        				    					//update the child objects
        										try
						{
	...
	{
		return bundle.getString("NewSubnetWizard.finishText",bundle.getString("wizard.finishText"));
	}
	
	public String getJavaScriptWaitStatement()
	{
		String text = bundle.getString("NewSubnetWizard.createWaitText",bundle.getString("wizard.createWaitText"));
