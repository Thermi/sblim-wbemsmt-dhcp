...
public class NewSubnetWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    public NewSubnetWizard(final org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "NewSubnetWizard.title");
        ...
        this.container = new org.sblim.wbemsmt.dhcp.wizard.NewSubnetWizardContainer(adapter,
                new org.sblim.wbemsmt.dhcp.wizard.NewSubnetWizardContainerPanels() {
                    ...
                    public DataContainer getNewSubnet() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard NewSubnetWizard", e);
                        }
                    }
                    ...
                    public DataContainer getNewSubnetSummary() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewSubnetSummaryContainerImpl(
                                    adapter, binding);
    ...
    public String getFinishText() {
        return bundle
                .getString("NewSubnetWizard.finishText", bundle.getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("NewSubnetWizard.createWaitText", bundle
