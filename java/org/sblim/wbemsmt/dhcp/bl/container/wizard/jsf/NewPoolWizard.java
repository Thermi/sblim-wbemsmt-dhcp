...
public class NewPoolWizard extends JSFWizardBase implements IPageWizardAdapter {
	...
	public NewPoolWizard(final org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter) {
		super(adapter,ResourceBundleManager.getResourceBundle(new String[]{"messages","messagesDhcp"},LocaleManager.getCurrent(FacesContext.getCurrentInstance()).getCurrentLocale()),"NewPoolWizard.title");
		...
		this.container = new org.sblim.wbemsmt.dhcp.wizard.NewPoolWizardContainer (adapter,new org.sblim.wbemsmt.dhcp.wizard.NewPoolWizardContainerPanels()
 			{
					...
					public Object getNewPool() throws WbemSmtException
					{
						...
						try
						{
    						panel1= new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewPoolContainerImpl(adapter,binding);
						...
						{
							throw new WbemSmtException("Cannot process Wizard NewPoolWizard",e);
						}
    				}
            						//update the child objects
					...
					public Object getNewPoolSummary() throws WbemSmtException
					{
						...
						try
						{
    						panel2= new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewPoolSummaryContainerImpl(adapter,binding);
   ...
   //Workaround for a bug within myFaces - Everytime a new panel is created the childs are created also
	...
	public void countAndCreateChilds(DataContainer dataContainer) throws UpdateControlsException {
            						if (dataContainer instanceof org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewPoolContainerImpl)
					{
						...
						{
							throw new UpdateControlsException("Cannot process Wizard NewPoolWizard",e);
						}
    				}
	...
	{
		String text = bundle.getString("NewPoolWizard.createWaitText",bundle.getString("wizard.createWaitText"));
