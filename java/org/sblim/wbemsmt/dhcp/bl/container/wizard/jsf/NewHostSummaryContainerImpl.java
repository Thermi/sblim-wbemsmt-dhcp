...
public class NewHostSummaryContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.dhcp.bl.container.wizard.NewHostSummaryContainer
	{
	...
	public NewHostSummaryContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,String bindingPrefix) throws InitContainerException  {

			
				super(adapter,bindingPrefix, "NewHostSummaryContainer.caption","NewHostSummaryContainer.subTitle",false);
		...
		setFooter(getPanelForCustomLayout(),"NewHostSummaryContainer.footerText");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Name() {
    		if (ic_Name == null)
    		{
				String label = bundle.getString("NewHostSummaryContainer.Name");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_MACAddr() {
    		if (ic_MACAddr == null)
    		{
				String label = bundle.getString("NewHostSummaryContainer.MACAddr");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_IPAddr() {
    		if (ic_IPAddr == null)
    		{
				String label = bundle.getString("NewHostSummaryContainer.IPAddr");
	...
	public void reload()
	{
		super.reload();
	    		if (ic_Name != null)
    		{
				ic_Name.setLabelText(bundle.getString("NewHostSummaryContainer.Name"));
    		}
	    		if (ic_MACAddr != null)
    		{
				ic_MACAddr.setLabelText(bundle.getString("NewHostSummaryContainer.MACAddr"));
    		}
	    		if (ic_IPAddr != null)
    		{
				ic_IPAddr.setLabelText(bundle.getString("NewHostSummaryContainer.IPAddr"));
    		}
		}
