/**
 * NewHostWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF THE
...
public class NewHostWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    public NewHostWizard(final org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "NewHostWizard.title");
        this.adapter = adapter;
        this.container = new org.sblim.wbemsmt.dhcp.wizard.NewHostWizardContainer(adapter,
                new org.sblim.wbemsmt.dhcp.wizard.NewHostWizardContainerPanels() {
                    //update the child objects

                    public DataContainer getNewHost() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewHostContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard NewHostWizard", e);
                        }
                    }

                    //update the child objects

                    public DataContainer getNewHostSummary() throws WbemsmtException {
                        //Workaround for Bug https://issues.apache.org/jira/browse/MYFACES-1438
                        //Create the panel everytime the panel is needed 
                        //if (panel2!= null)
                        //{
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.dhcp.bl.container.wizard.jsf.NewHostSummaryContainerImpl(
                                    adapter, binding);
    ...
    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("NewHostWizard.createWaitText", bundle
