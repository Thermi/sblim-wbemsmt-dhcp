...
public class DHCPSubnetParamsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetParamsContainer
	{
	...
	public DHCPSubnetParamsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DHCPSubnetParamsContainer.caption",false);
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_Range != null)
    		{
	    		...
	    		if (ic_usr_Defaultleasetime != null)
    		{
				ic_usr_Defaultleasetime.setLabelText(bundle.getString("DHCPSubnetParamsContainer.defaultleasetime"));
    		}
	    		if (ic_usr_Maxleasetime != null)
    		{
				ic_usr_Maxleasetime.setLabelText(bundle.getString("DHCPSubnetParamsContainer.maxleasetime"));
    		}
		}
