...
public class DHCPSubnetOptionsContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetOptionsContainer
	{
	...
	public DHCPSubnetOptionsContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Subnetmask() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPSubnetOptionsContainer.subnetmask");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Broadcastaddress() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPSubnetOptionsContainer.broadcastaddress");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Domainnameservers() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPSubnetOptionsContainer.domainnameservers");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Domainname() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPSubnetOptionsContainer.domainname");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("DHCPSubnetOptionsContainer.caption"));
		}
