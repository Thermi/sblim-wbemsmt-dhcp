...
public class DHCPSharednetParamsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednetParamsContainer {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_Maxleasetime;

    public DHCPSharednetParamsContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_Maxleasetime != null) {
            ic_usr_Maxleasetime.setLabelText(bundle
                    .getString("DHCPSharednetParamsContainer.maxleasetime"));
        }
    }
