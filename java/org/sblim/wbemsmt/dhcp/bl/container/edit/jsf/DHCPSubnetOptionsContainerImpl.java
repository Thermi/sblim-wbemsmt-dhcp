...
public class DHCPSubnetOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSubnetOptionsContainer {
    ...
    public DHCPSubnetOptionsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_Subnetmask != null) {
            ic_usr_Subnetmask.setLabelText(bundle
                    .getString("DHCPSubnetOptionsContainer.subnetmask"));
        }
        if (ic_usr_Broadcastaddress != null) {
            ic_usr_Broadcastaddress.setLabelText(bundle
                    .getString("DHCPSubnetOptionsContainer.broadcastaddress"));
        }
        if (ic_usr_Domainnameservers != null) {
            ic_usr_Domainnameservers.setLabelText(bundle
                    .getString("DHCPSubnetOptionsContainer.domainnameservers"));
        }
        if (ic_usr_Domainname != null) {
            ic_usr_Domainname.setLabelText(bundle
                    .getString("DHCPSubnetOptionsContainer.domainname"));
        }
        if (ic_usr_Routers != null) {
