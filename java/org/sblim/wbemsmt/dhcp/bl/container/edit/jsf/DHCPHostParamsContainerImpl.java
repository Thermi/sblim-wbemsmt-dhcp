...
public class DHCPHostParamsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostParamsContainer {
    ...
    public DHCPHostParamsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_Fixedaddress != null) {
            ic_usr_Fixedaddress.setLabelText(bundle
                    .getString("DHCPHostParamsContainer.fixedaddress"));
        }
        if (ic_usr_Hardware != null) {
