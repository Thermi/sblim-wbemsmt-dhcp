...
public class DHCPPoolOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolOptionsContainer {
    ...
    public DHCPPoolOptionsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "DHCPPoolOptionsContainer.caption", false);
        ...
        setFooter(getPanelForCustomLayout(), "DHCPPoolOptionsContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Domainnameservers() {
        if (ic_usr_Domainnameservers == null) {
            String label = bundle.getString("DHCPPoolOptionsContainer.domainnameservers");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Domainname() {
        if (ic_usr_Domainname == null) {
            String label = bundle.getString("DHCPPoolOptionsContainer.domainname");
    ...
    public void reload() {
        ...
        if (ic_usr_Domainnameservers != null) {
            ic_usr_Domainnameservers.setLabelText(bundle
                    .getString("DHCPPoolOptionsContainer.domainnameservers"));
        }
        if (ic_usr_Domainname != null) {
            ic_usr_Domainname.setLabelText(bundle.getString("DHCPPoolOptionsContainer.domainname"));
        }
    }
