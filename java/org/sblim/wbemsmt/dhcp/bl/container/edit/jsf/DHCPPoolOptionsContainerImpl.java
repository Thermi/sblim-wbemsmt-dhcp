...
public class DHCPPoolOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolOptionsContainer
	{
	...
	public DHCPPoolOptionsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DHCPPoolOptionsContainer.caption",false);
	...
	public void reload()
	{
		super.reload();
	    		if (ic_usr_Domainnameservers != null)
    		{
				ic_usr_Domainnameservers.setLabelText(bundle.getString("DHCPPoolOptionsContainer.domainnameservers"));
    		}
	    		if (ic_usr_Domainname != null)
    		{
