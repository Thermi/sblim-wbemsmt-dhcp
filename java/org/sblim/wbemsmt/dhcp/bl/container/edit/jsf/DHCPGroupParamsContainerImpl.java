...
public class DHCPGroupParamsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGroupParamsContainer {
    ...
    public DHCPGroupParamsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Filename() {
        if (ic_usr_Filename == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Filename = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_usr_Maxleasetime != null) {
            ic_usr_Maxleasetime.setLabelText(bundle
                    .getString("DHCPGroupParamsContainer.maxleasetime"));
        }
        if (ic_usr_Defaultleasetime != null) {
            ic_usr_Defaultleasetime.setLabelText(bundle
                    .getString("DHCPGroupParamsContainer.defaultleasetime"));
        }
    }
