...
public class DhcpServiceConfContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DhcpServiceConfContainer {
    ...
    public DhcpServiceConfContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_ConfigurationFile != null) {
            ic_ConfigurationFile.setLabelText(bundle
                    .getString("DhcpServiceConfContainer.ConfigurationFile"));
        }
        if (ic_invoke_StartService != null) {
            ic_invoke_StartService.setLabelText(bundle
                    .getString("DhcpServiceConfContainer.startService"));
        }
        if (ic_invoke_StopService != null) {
            ic_invoke_StopService.setLabelText(bundle
                    .getString("DhcpServiceConfContainer.stopService"));
        }
        if (ic_usr_Restartservice != null) {
            ic_usr_Restartservice.setLabelText(bundle
                    .getString("DhcpServiceConfContainer.restartservice"));
        }
    }
