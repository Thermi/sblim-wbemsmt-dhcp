...
public class DHCPSharednerOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPSharednerOptionsContainer {
    ...
    public DHCPSharednerOptionsContainerImpl(
    ...
    public void reload() {
        ...
        if (ic_usr_Domainnameservers != null) {
            ic_usr_Domainnameservers.setLabelText(bundle
                    .getString("DHCPSharednerOptionsContainer.domainnameservers"));
        }
        if (ic_usr_Domainname != null) {
            ic_usr_Domainname.setLabelText(bundle
                    .getString("DHCPSharednerOptionsContainer.domainname"));
        }
    }
