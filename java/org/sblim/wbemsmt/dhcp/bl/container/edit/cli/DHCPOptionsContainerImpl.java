...
public class DHCPOptionsContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPOptionsContainer {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_Values;
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_Name;

    public DHCPOptionsContainerImpl(AbstractBaseCimAdapter adapter) throws WbemsmtException {
        super();
        setAdapter(adapter);
