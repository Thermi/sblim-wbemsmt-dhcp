...
public class DHCPGlobalOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGlobalOptionsContainer {
    ...
    public DHCPGlobalOptionsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Timeoffset() {
        if (ic_usr_Timeoffset == null) {
            ...
            ic_usr_Timeoffset = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Subnetmask() {
        if (ic_usr_Subnetmask == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Subnetmask = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Domainname() {
        if (ic_usr_Domainname == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Domainname = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Staticroutes() {
        if (ic_usr_Staticroutes == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Staticroutes = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Policyfilter() {
        if (ic_usr_Policyfilter == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Policyfilter = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Interfacemtu() {
        if (ic_usr_Interfacemtu == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Interfacemtu = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Hostname() {
        if (ic_usr_Hostname == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Hostname = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Dhcpclientidentifier() {
        if (ic_usr_Dhcpclientidentifier == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Dhcpclientidentifier = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Trailerencapsulation() {
        if (ic_usr_Trailerencapsulation == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Trailerencapsulation = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Ipforwarding() {
        if (ic_usr_Ipforwarding == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Ipforwarding = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Nonlocalsourcerouting() {
        if (ic_usr_Nonlocalsourcerouting == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Nonlocalsourcerouting = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Defaultipttl() {
        if (ic_usr_Defaultipttl == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Defaultipttl = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Defaulttcpttl() {
        if (ic_usr_Defaulttcpttl == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Defaulttcpttl = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Routers() {
        if (ic_usr_Routers == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Routers = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Broadcastaddress() {
        if (ic_usr_Broadcastaddress == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Broadcastaddress = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Domainnameservers() {
        if (ic_usr_Domainnameservers == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Domainnameservers = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        super.reload();
        if (ic_usr_Timeoffset != null) {
            ic_usr_Timeoffset.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.timeoffset"));
        }
        if (ic_usr_Subnetmask != null) {
            ic_usr_Subnetmask.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.subnetmask"));
        }
        if (ic_usr_Domainname != null) {
            ic_usr_Domainname.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.domainname"));
        }
        if (ic_usr_Staticroutes != null) {
            ic_usr_Staticroutes.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.staticroutes"));
        }
        if (ic_usr_Policyfilter != null) {
            ic_usr_Policyfilter.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.policyfilter"));
        }
        if (ic_usr_Interfacemtu != null) {
            ic_usr_Interfacemtu.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.interfacemtu"));
        }
        if (ic_usr_Hostname != null) {
            ic_usr_Hostname.setLabelText(bundle.getString("DHCPGlobalOptionsContainer.hostname"));
        }
        if (ic_usr_Dhcpclientidentifier != null) {
            ic_usr_Dhcpclientidentifier.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.dhcpclientidentifier"));
        }
        if (ic_usr_Trailerencapsulation != null) {
            ic_usr_Trailerencapsulation.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.trailerencapsulation"));
        }
        if (ic_usr_Ipforwarding != null) {
            ic_usr_Ipforwarding.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.ipforwarding"));
        }
        if (ic_usr_Nonlocalsourcerouting != null) {
            ic_usr_Nonlocalsourcerouting.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.nonlocalsourcerouting"));
        }
        if (ic_usr_Defaultipttl != null) {
            ic_usr_Defaultipttl.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.defaultipttl"));
        }
        if (ic_usr_Defaulttcpttl != null) {
            ic_usr_Defaulttcpttl.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.defaulttcpttl"));
        }
        if (ic_usr_Routers != null) {
            ic_usr_Routers.setLabelText(bundle.getString("DHCPGlobalOptionsContainer.routers"));
        }
        if (ic_usr_Broadcastaddress != null) {
            ic_usr_Broadcastaddress.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.broadcastaddress"));
        }
        if (ic_usr_Domainnameservers != null) {
            ic_usr_Domainnameservers.setLabelText(bundle
                    .getString("DHCPGlobalOptionsContainer.domainnameservers"));
        }
    }
