...
public class DHCPHostOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPHostOptionsContainer {
    ...
    public DHCPHostOptionsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "DHCPHostOptionsContainer.caption", false);
    ...
    public void reload() {
        ...
        if (ic_usr_Domainnameservers != null) {
            ic_usr_Domainnameservers.setLabelText(bundle
                    .getString("DHCPHostOptionsContainer.domainnameservers"));
        }
        if (ic_usr_Domainname != null) {
        ...
        if (ic_usr_Dhcpclientidentifier != null) {
            ic_usr_Dhcpclientidentifier.setLabelText(bundle
                    .getString("DHCPHostOptionsContainer.dhcpclientidentifier"));
        }
    }
