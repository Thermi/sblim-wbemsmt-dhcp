...
public class DHCPPoolParamsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolParamsContainer {
    ...
    public DHCPPoolParamsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_Allowmembersof != null) {
            ic_usr_Allowmembersof.setLabelText(bundle
                    .getString("DHCPPoolParamsContainer.allowmembersof"));
        }
        if (ic_usr_Deny != null) {
        ...
        if (ic_usr_Denymembersof != null) {
            ic_usr_Denymembersof.setLabelText(bundle
                    .getString("DHCPPoolParamsContainer.denymembersof"));
        }
        if (ic_usr_Maxleasetime != null) {
            ic_usr_Maxleasetime.setLabelText(bundle
                    .getString("DHCPPoolParamsContainer.maxleasetime"));
        }
    }
