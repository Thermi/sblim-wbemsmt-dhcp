...
public class DHCPPoolParamsContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPPoolParamsContainer
	{
	...
	public DHCPPoolParamsContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Allowmembersof() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPPoolParamsContainer.allowmembersof");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Denymembersof() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPPoolParamsContainer.denymembersof");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Maxleasetime() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DHCPPoolParamsContainer.maxleasetime");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("DHCPPoolParamsContainer.caption"));
		}
