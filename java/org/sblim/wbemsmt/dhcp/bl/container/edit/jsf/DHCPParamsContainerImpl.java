...
public class DHCPParamsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public DHCPParamsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
            String bindingPrefix) throws WbemsmtException {

        super(adapter, bindingPrefix, "DHCPParamsContainer.caption", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Values() {
        if (ic_Values == null) {
            ...
            ic_Values = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(parent,
