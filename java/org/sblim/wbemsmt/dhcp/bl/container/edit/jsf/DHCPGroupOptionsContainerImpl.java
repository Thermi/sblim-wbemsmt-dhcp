...
public class DHCPGroupOptionsContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dhcp.bl.container.edit.DHCPGroupOptionsContainer {
    ...
    public DHCPGroupOptionsContainerImpl(org.sblim.wbemsmt.dhcp.bl.adapter.DhcpCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_Domainname != null) {
            ic_usr_Domainname
                    .setLabelText(bundle.getString("DHCPGroupOptionsContainer.domainname"));
        }
        if (ic_usr_Domainnameservers != null) {
            ic_usr_Domainnameservers.setLabelText(bundle
                    .getString("DHCPGroupOptionsContainer.domainnameservers"));
        }
        if (ic_usr_Routers != null) {
