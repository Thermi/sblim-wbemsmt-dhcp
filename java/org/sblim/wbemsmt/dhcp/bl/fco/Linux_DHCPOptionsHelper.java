...
public class Linux_DHCPOptionsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPOptions.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(Linux_DHCPOptions.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPOptions.");
                        resultArrayList.add(new Linux_DHCPOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPOptions.");
                        resultArrayList.add(new Linux_DHCPOptions(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPOptions.");
                        resultArrayList.add(new Linux_DHCPOptions(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPOptions getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPOptions getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPOptions getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPOptions.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPOptions.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPOptions createInstance(WBEMClient client,
            Linux_DHCPOptions dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPOptions newDataInstance = Linux_DHCPOptionsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DHCPOptions modifyInstance(WBEMClient client,
            Linux_DHCPOptions dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPOptions dataInstance2 = Linux_DHCPOptionsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPOptions dataInstance)
            throws WbemsmtException {
