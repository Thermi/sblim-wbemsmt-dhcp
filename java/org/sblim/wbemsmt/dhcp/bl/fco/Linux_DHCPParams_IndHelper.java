...
public class Linux_DHCPParams_IndHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPParams_Ind.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPParams_Ind.CIM_CLASS_NAME
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPParams_Ind.");
                        resultArrayList.add(new Linux_DHCPParams_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPParams_Ind.");
                        resultArrayList.add(new Linux_DHCPParams_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPParams_Ind.");
                        resultArrayList.add(new Linux_DHCPParams_Ind(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPParams_Ind getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPParams_Ind getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static Linux_DHCPParams_Ind createInstance(WBEMClient client,
            Linux_DHCPParams_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPParams_Ind newDataInstance = Linux_DHCPParams_IndHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DHCPParams_Ind modifyInstance(WBEMClient client,
            Linux_DHCPParams_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPParams_Ind dataInstance2 = Linux_DHCPParams_IndHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPParams_Ind dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPParams_Ind.getPackages());
    }
