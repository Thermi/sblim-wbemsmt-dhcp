...
public class Linux_DHCPOptionsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPOptionsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPOptionsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPOptionsForEntity.");
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPOptionsForEntity.");
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPOptionsForEntity.");
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPOptionsForEntity getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPOptionsForEntity getInstance(WBEMClient client, String namespace,
            Linux_DHCPEntity GroupComponent, Linux_DHCPOptions PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPOptionsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPOptionsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPOPTIONS.NAME,
                new CIMDataType(Linux_DHCPOptions.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPOptionsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPOptionsForEntity createInstance(WBEMClient client,
            Linux_DHCPOptionsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPOptionsForEntity newDataInstance = Linux_DHCPOptionsForEntityHelper.getInstance(
     ...
     */
    public final static Linux_DHCPOptionsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPOptionsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPOptionsForEntity dataInstance2 = Linux_DHCPOptionsForEntityHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPOptionsForEntity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPOptionsForEntity.getPackages());
    }
