/** 
  * Linux_DHCPOptionsForEntityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPOptionsForEntity
  *    
  * 
  * generated Class
  * @see Linux_DHCPOptionsForEntity
  */
...
public class Linux_DHCPOptionsForEntityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPOptionsForEntity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPOptionsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPOptionsForEntity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPOptionsForEntity or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPOptionsForEntity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPOptionsForEntity> resultArrayList = new ArrayList<Linux_DHCPOptionsForEntity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPOptionsForEntity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPOptionsForEntityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPOptionsForEntity.");
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPOptionsForEntity.");
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPOptionsForEntity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPOptionsForEntity.");
                        resultArrayList.add(new Linux_DHCPOptionsForEntity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPOptionsForEntity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPOptionsForEntity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPOptionsForEntity dataInstance = null;
        Class<?> clazz = Linux_DHCPOptionsForEntityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPOptionsForEntity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPOptionsForEntity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPOptionsForEntity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPOptionsForEntity getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPEntity GroupComponent
                                                       ,Linux_DHCPOptions PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPOptionsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,new CIMDataType(Linux_DHCPEntity.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPOptionsForEntity.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPOptionsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPOPTIONS.NAME,new CIMDataType(Linux_DHCPOptions.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPOptionsForEntity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPOptionsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPOptionsForEntity createInstance(WBEMClient client, Linux_DHCPOptionsForEntity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPOptionsForEntity newDataInstance = Linux_DHCPOptionsForEntityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPOptionsForEntity modifyInstance(WBEMClient client, Linux_DHCPOptionsForEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPOptionsForEntity dataInstance2 = Linux_DHCPOptionsForEntityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPOptionsForEntity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPOptionsForEntity.getPackages());
    }
