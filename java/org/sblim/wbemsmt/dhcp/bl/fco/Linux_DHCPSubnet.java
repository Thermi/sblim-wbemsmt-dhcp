...
public class Linux_DHCPSubnet extends Linux_DHCPEntity {
    ...
    public String get_Netmask() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_NETMASK.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_Netmask(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPSubnetsForEntitys(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPSubnetsForEntitys(cimClient,
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPSubnetsForEntityNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPSubnetsForEntityNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DHCPSUBNETSFORENTITY,
