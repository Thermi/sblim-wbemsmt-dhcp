...
public class Linux_DHCPSubnetsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPSubnetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPSubnetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPSubnetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPSubnetsForEntity getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPSubnetsForEntity getInstance(WBEMClient client, String namespace,
            Linux_DHCPEntity GroupComponent, Linux_DHCPSubnet PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPSubnetsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPSubnetsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME,
                new CIMDataType(Linux_DHCPSubnet.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPSubnetsForEntity createInstance(WBEMClient client,
            Linux_DHCPSubnetsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPSubnetsForEntity newDataInstance = Linux_DHCPSubnetsForEntityHelper.getInstance(
     ...
     */
    public final static Linux_DHCPSubnetsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPSubnetsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPSubnetsForEntity dataInstance2 = Linux_DHCPSubnetsForEntityHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPSubnetsForEntity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPSubnetsForEntity.getPackages());
    }
