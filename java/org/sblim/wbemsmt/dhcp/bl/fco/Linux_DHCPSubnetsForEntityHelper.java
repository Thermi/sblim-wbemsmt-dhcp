/** 
  * Linux_DHCPSubnetsForEntityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPSubnetsForEntity
  *    
  * 
  * generated Class
  * @see Linux_DHCPSubnetsForEntity
  */
...
public class Linux_DHCPSubnetsForEntityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPSubnetsForEntity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPSubnetsForEntity or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPSubnetsForEntity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPSubnetsForEntity> resultArrayList = new ArrayList<Linux_DHCPSubnetsForEntity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPSubnetsForEntityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPSubnetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPSubnetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPSubnetsForEntity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSubnetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSubnetsForEntity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPSubnetsForEntity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPSubnetsForEntity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPSubnetsForEntity dataInstance = null;
        Class<?> clazz = Linux_DHCPSubnetsForEntityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPSubnetsForEntity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSubnetsForEntity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPSubnetsForEntity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPSubnetsForEntity getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPEntity GroupComponent
                                                       ,Linux_DHCPSubnet PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPSubnetsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,new CIMDataType(Linux_DHCPEntity.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPSubnetsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME,new CIMDataType(Linux_DHCPSubnet.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPSubnetsForEntity createInstance(WBEMClient client, Linux_DHCPSubnetsForEntity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPSubnetsForEntity newDataInstance = Linux_DHCPSubnetsForEntityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPSubnetsForEntity modifyInstance(WBEMClient client, Linux_DHCPSubnetsForEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPSubnetsForEntity dataInstance2 = Linux_DHCPSubnetsForEntityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPSubnetsForEntity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPSubnetsForEntity.getPackages());
    }
