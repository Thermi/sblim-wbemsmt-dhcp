/** 
  * Linux_DHCPGroupsForEntityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPGroupsForEntity
  *    
  * 
  * generated Class
  * @see Linux_DHCPGroupsForEntity
  */
...
public class Linux_DHCPGroupsForEntityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPGroupsForEntity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPGroupsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPGroupsForEntity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPGroupsForEntity or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPGroupsForEntity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPGroupsForEntity> resultArrayList = new ArrayList<Linux_DHCPGroupsForEntity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPGroupsForEntity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPGroupsForEntityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPGroupsForEntity.");
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPGroupsForEntity.");
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPGroupsForEntity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPGroupsForEntity.");
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPGroupsForEntity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPGroupsForEntity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPGroupsForEntity dataInstance = null;
        Class<?> clazz = Linux_DHCPGroupsForEntityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPGroupsForEntity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPGroupsForEntity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPGroupsForEntity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPGroupsForEntity getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPEntity GroupComponent
                                                       ,Linux_DHCPGroup PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPGroupsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,new CIMDataType(Linux_DHCPEntity.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPGroupsForEntity.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPGroupsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME,new CIMDataType(Linux_DHCPGroup.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPGroupsForEntity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPGroupsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPGroupsForEntity createInstance(WBEMClient client, Linux_DHCPGroupsForEntity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPGroupsForEntity newDataInstance = Linux_DHCPGroupsForEntityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPGroupsForEntity modifyInstance(WBEMClient client, Linux_DHCPGroupsForEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPGroupsForEntity dataInstance2 = Linux_DHCPGroupsForEntityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPGroupsForEntity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPGroupsForEntity.getPackages());
    }
