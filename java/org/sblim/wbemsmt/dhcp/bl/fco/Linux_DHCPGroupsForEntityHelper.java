...
public class Linux_DHCPGroupsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPGroupsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPGroupsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPGroupsForEntity.");
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPGroupsForEntity.");
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPGroupsForEntity.");
                        resultArrayList.add(new Linux_DHCPGroupsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPGroupsForEntity getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPGroupsForEntity getInstance(WBEMClient client, String namespace,
            Linux_DHCPEntity GroupComponent, Linux_DHCPGroup PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPGroupsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPGroupsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME,
                new CIMDataType(Linux_DHCPGroup.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPGroupsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPGroupsForEntity createInstance(WBEMClient client,
            Linux_DHCPGroupsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPGroupsForEntity newDataInstance = Linux_DHCPGroupsForEntityHelper.getInstance(
     ...
     */
    public final static Linux_DHCPGroupsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPGroupsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPGroupsForEntity dataInstance2 = Linux_DHCPGroupsForEntityHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPGroupsForEntity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPGroupsForEntity.getPackages());
    }
