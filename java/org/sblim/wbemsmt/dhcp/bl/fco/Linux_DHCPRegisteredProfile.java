...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<Linux_DHCPService> getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfiles(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfiles(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<Linux_DHCPService> getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfiles(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfileNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfileNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_LINUX_DHCPELEMENTCONFORMSTOPROFILE,
    	                             Linux_DHCPService.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfileNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_DHCPService_Linux_DHCPElementConformsToProfileNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
   ...
   public java.util.List<Linux_DHCPElementConformsToProfile> getAssociations_Linux_DHCPElementConformsToProfile(WBEMClient cimClient, boolean includeQualifiers, boolean includeClassOrigin, String role,java.lang.String[] propertyList) throws WbemsmtException {

       if (cimClient == null) {
            throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
       }

       java.util.List<Linux_DHCPElementConformsToProfile> result = new java.util.ArrayList<Linux_DHCPElementConformsToProfile>();
       CloseableIterator enumeration = null;
          ...
          while (enumeration.hasNext()) {
             ...
             if (obj instanceof CIMInstance) {
                ...
                try {
                   Object[] actargs = new Object[] {cimInstance};
                   Object dataObj = cons.newInstance(actargs);
                   result.add((Linux_DHCPElementConformsToProfile)dataObj);
                } catch (Exception e) {
                   System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                   result.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                   continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociationNames_Linux_DHCPElementConformsToProfile(WBEMClient cimClient,String role, boolean deep) throws WbemsmtException {
        ...
        try {
                while (enumeration.hasNext()) {
                   ...
                   if (obj instanceof CIMObjectPath) {
                      if (deep || ((CIMObjectPath)obj).getObjectName().equals(Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME)) {
                         result.add((CIMObjectPath)obj);
                      }
                   }
                }
