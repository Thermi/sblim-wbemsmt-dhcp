...
public class Linux_DHCPHostHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPHost.CIM_CLASS_NAME,
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class Linux_DHCPHost.");
                        resultArrayList.add(new Linux_DHCPHost(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class Linux_DHCPHost.");
                        resultArrayList.add(new Linux_DHCPHost(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPHost.");
                        resultArrayList.add(new Linux_DHCPHost(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPHost getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPHost getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPHost getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPHost.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPHost.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPHost createInstance(WBEMClient client,
            Linux_DHCPHost dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPHost modifyInstance(WBEMClient client,
            Linux_DHCPHost dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPHost dataInstance2 = Linux_DHCPHostHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPHost dataInstance)
            throws WbemsmtException {
