...
public class Linux_DHCPEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPEntity.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPEntity.");
                        resultArrayList.add(new Linux_DHCPEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPEntity.");
                        resultArrayList.add(new Linux_DHCPEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPEntity.");
                        resultArrayList.add(new Linux_DHCPEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPEntity getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPEntity getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPEntity getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPEntity.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPEntity createInstance(WBEMClient client,
            Linux_DHCPEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPEntity newDataInstance = Linux_DHCPEntityHelper
     ...
     */
    public final static Linux_DHCPEntity modifyInstance(WBEMClient client,
            Linux_DHCPEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPEntity dataInstance2 = Linux_DHCPEntityHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPEntity dataInstance)
            throws WbemsmtException {
