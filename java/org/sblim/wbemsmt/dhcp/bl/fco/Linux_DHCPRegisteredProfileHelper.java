...
public class Linux_DHCPRegisteredProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPRegisteredProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPRegisteredProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPRegisteredProfile.");
                        resultArrayList.add(new Linux_DHCPRegisteredProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPRegisteredProfile.");
                        resultArrayList.add(new Linux_DHCPRegisteredProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPRegisteredProfile.");
                        resultArrayList.add(new Linux_DHCPRegisteredProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPRegisteredProfile getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPRegisteredProfile getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPRegisteredProfile.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static Linux_DHCPRegisteredProfile createInstance(WBEMClient client,
            Linux_DHCPRegisteredProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPRegisteredProfile newDataInstance = Linux_DHCPRegisteredProfileHelper
     ...
     */
    public final static Linux_DHCPRegisteredProfile modifyInstance(WBEMClient client,
            Linux_DHCPRegisteredProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPRegisteredProfile dataInstance2 = Linux_DHCPRegisteredProfileHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPRegisteredProfile dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPRegisteredProfile.getPackages());
    }
