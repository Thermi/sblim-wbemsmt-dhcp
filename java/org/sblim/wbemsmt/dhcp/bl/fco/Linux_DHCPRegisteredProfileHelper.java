...
public final class Linux_DHCPRegisteredProfileHelper {
	...
	*/	
	public final static Linux_DHCPRegisteredProfile getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_DHCPRegisteredProfileHelper.getInstance(cimClient, new Linux_DHCPRegisteredProfile(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DHCPRegisteredProfile getInstance(CIMClient cimClient, Linux_DHCPRegisteredProfile dataInstance) {
		...
		return Linux_DHCPRegisteredProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DHCPRegisteredProfile getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_DHCPRegisteredProfile(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_DHCPRegisteredProfile.getPackages();
	...
	*/	
	public final static Linux_DHCPRegisteredProfile createInstance(CIMClient cimClient, Linux_DHCPRegisteredProfile dataInstance, boolean notifyDifferencies){ 
		...
		Linux_DHCPRegisteredProfile newDataInstance = null;
		try {
			newDataInstance = Linux_DHCPRegisteredProfileHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DHCPRegisteredProfile modifyInstance(CIMClient cimClient, Linux_DHCPRegisteredProfile dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_DHCPRegisteredProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_DHCPRegisteredProfile dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_DHCPRegisteredProfile dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_DHCPRegisteredProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_DHCPRegisteredProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_DHCPRegisteredProfile.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_DHCPRegisteredProfile.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_DHCPRegisteredProfile.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
