...
public class Linux_DHCPSharednet extends Linux_DHCPEntity {
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPSharednetsForEntitys(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPSharednetsForEntitys(cimClient,
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPSharednetsForEntityNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPSharednetsForEntityNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DHCPSHAREDNETSFORENTITY,
