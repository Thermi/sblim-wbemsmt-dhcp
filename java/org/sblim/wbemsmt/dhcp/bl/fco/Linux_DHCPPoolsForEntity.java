 ...
 * 
 * Description: The hierarchial structure fo the dhcp viz subnets inside sharednets ,pools within subnets ..etc can be achieved by using this association.Here the Pool entity is associated with DHCPEntity which can be any of the classes extending the DHCPEntity class.
 * 
 * generated Class
 */
...
public class Linux_DHCPPoolsForEntity extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL {
        /**
    ...
    public Linux_DHCPPoolsForEntity(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DHCPPoolsForEntity(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DHCPPoolsForEntity() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PartComponent", new CIMProperty("PartComponent", new CIMDataType(
                Linux_DHCPPool.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_GroupComponent_Linux_DHCPEntity(WBEMClient client,
        ...
        Linux_DHCPPoolsForEntity fco = new Linux_DHCPPoolsForEntity(client, namespace);
    ...
    public Linux_DHCPPool get_PartComponent_Linux_DHCPPool(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_DHCPPoolHelper.getInstance(client, (CIMObjectPath) currentProperty.getValue());
    ...
    public boolean set_PartComponent_Linux_DHCPPool(Linux_DHCPPool newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_PartComponent_Linux_DHCPPool(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME
    ...
    public static CIMProperty create_PartComponent_Linux_DHCPPool(WBEMClient client,
            String namespace, Linux_DHCPPool newValue) throws WbemsmtException {
        Linux_DHCPPoolsForEntity fco = new Linux_DHCPPoolsForEntity(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_Linux_DHCPPool(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_Linux_DHCPPool(
            CIMProperty currentProperty, Linux_DHCPPool newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_DHCPPoolsForEntity.CIM_CLASS_NAME;
    }
