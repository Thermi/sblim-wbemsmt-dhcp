...
public class Linux_DHCPParams extends CIM_SettingData {
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPParamsForEntitys(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPParamsForEntitys(cimClient,
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPParamsForEntityNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPParamsForEntityNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DHCPPARAMSFORENTITY,
