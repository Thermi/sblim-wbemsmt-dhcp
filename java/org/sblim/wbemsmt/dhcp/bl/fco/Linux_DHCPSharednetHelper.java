...
public class Linux_DHCPSharednetHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSharednet.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPSharednet.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(Linux_DHCPSharednet.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DHCPSharednet.");
                        resultArrayList.add(new Linux_DHCPSharednet(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPSharednet.");
                        resultArrayList.add(new Linux_DHCPSharednet(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPSharednet.");
                        resultArrayList.add(new Linux_DHCPSharednet(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPSharednet getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPSharednet getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPSharednet getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPSharednet.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPSharednet.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPSharednet createInstance(WBEMClient client,
            Linux_DHCPSharednet dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPSharednet newDataInstance = Linux_DHCPSharednetHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DHCPSharednet modifyInstance(WBEMClient client,
            Linux_DHCPSharednet dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPSharednet dataInstance2 = Linux_DHCPSharednetHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPSharednet dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPSharednet.getPackages());
    }
