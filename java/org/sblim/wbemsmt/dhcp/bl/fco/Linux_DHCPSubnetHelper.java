/** 
  ...
  * 
  * Description: Helper class for Linux_DHCPSubnet
  *    
  * 
  * generated Class
  * @see Linux_DHCPSubnet
  */
...
public class Linux_DHCPSubnetHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPSubnet or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnet.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPSubnet.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPSubnet or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPSubnet> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPSubnet> resultArrayList = new ArrayList<Linux_DHCPSubnet>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPSubnet.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPSubnetHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPSubnet.");
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPSubnet.");
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPSubnet)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSubnet.");
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPSubnet getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPSubnet getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPSubnet dataInstance = null;
        Class<?> clazz = Linux_DHCPSubnetHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPSubnet)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSubnet.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPSubnet(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPSubnet getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPSubnet.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_DHCPSubnet.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnet.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPSubnet createInstance(WBEMClient client, Linux_DHCPSubnet dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPSubnet newDataInstance = Linux_DHCPSubnetHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPSubnet modifyInstance(WBEMClient client, Linux_DHCPSubnet dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPSubnet dataInstance2 = Linux_DHCPSubnetHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPSubnet dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPSubnet.getPackages());
    }
