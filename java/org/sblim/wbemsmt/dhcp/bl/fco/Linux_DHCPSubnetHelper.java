...
public class Linux_DHCPSubnetHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnet.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPSubnet.");
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPSubnet.");
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPSubnet.");
                        resultArrayList.add(new Linux_DHCPSubnet(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPSubnet getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPSubnet getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPSubnet getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPSubnet.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPSubnet.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPSubnet createInstance(WBEMClient client,
            Linux_DHCPSubnet dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPSubnet newDataInstance = Linux_DHCPSubnetHelper
     ...
     */
    public final static Linux_DHCPSubnet modifyInstance(WBEMClient client,
            Linux_DHCPSubnet dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPSubnet dataInstance2 = Linux_DHCPSubnetHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPSubnet dataInstance)
            throws WbemsmtException {
