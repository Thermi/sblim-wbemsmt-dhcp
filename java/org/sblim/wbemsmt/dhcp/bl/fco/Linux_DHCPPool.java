...
public class Linux_DHCPPool extends Linux_DHCPEntity {
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPPoolsForEntitys(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPPoolsForEntitys(cimClient,
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPPoolsForEntityNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPPoolsForEntityNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DHCPPOOLSFORENTITY,
