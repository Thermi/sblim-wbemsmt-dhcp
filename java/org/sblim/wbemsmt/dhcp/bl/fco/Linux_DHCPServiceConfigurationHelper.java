...
public final class Linux_DHCPServiceConfigurationHelper {
	...
	*/	
	public final static Linux_DHCPServiceConfiguration getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_DHCPServiceConfigurationHelper.getInstance(cimClient, new Linux_DHCPServiceConfiguration(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DHCPServiceConfiguration getInstance(CIMClient cimClient, Linux_DHCPServiceConfiguration dataInstance) {
		...
		return Linux_DHCPServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DHCPServiceConfiguration getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_DHCPServiceConfiguration(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_DHCPServiceConfiguration.getPackages();
	...
	*/	
	public final static Linux_DHCPServiceConfiguration createInstance(CIMClient cimClient, Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		Linux_DHCPServiceConfiguration newDataInstance = null;
		try {
			newDataInstance = Linux_DHCPServiceConfigurationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DHCPServiceConfiguration modifyInstance(CIMClient cimClient, Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_DHCPServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_DHCPServiceConfiguration dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_DHCPServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_DHCPServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_DHCPServiceConfiguration.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_DHCPServiceConfiguration.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_DHCPServiceConfiguration.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
