...
public class Linux_DHCPServiceConfigurationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPServiceConfiguration.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPServiceConfiguration.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DHCPServiceConfigurationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DHCPServiceConfiguration.");
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPServiceConfiguration.");
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPServiceConfiguration.");
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPServiceConfiguration getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPServiceConfiguration getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPServiceConfiguration.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static Linux_DHCPServiceConfiguration createInstance(WBEMClient client,
            Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPServiceConfiguration newDataInstance = Linux_DHCPServiceConfigurationHelper
     ...
     */
    public final static Linux_DHCPServiceConfiguration modifyInstance(WBEMClient client,
            Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPServiceConfiguration dataInstance2 = Linux_DHCPServiceConfigurationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPServiceConfiguration dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPServiceConfiguration.getPackages());
    }
