/** 
  * Linux_DHCPServiceConfigurationHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPServiceConfiguration
  *    
  * 
  * generated Class
  * @see Linux_DHCPServiceConfiguration
  */
...
public class Linux_DHCPServiceConfigurationHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPServiceConfiguration or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPServiceConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPServiceConfiguration.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPServiceConfiguration or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPServiceConfiguration> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPServiceConfiguration> resultArrayList = new ArrayList<Linux_DHCPServiceConfiguration>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPServiceConfiguration.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPServiceConfigurationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPServiceConfiguration.");
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPServiceConfiguration.");
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPServiceConfiguration)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPServiceConfiguration.");
                        resultArrayList.add(new Linux_DHCPServiceConfiguration(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPServiceConfiguration getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPServiceConfiguration getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPServiceConfiguration dataInstance = null;
        Class<?> clazz = Linux_DHCPServiceConfigurationHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPServiceConfiguration)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPServiceConfiguration.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPServiceConfiguration(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPServiceConfiguration getInstance(WBEMClient client, String namespace
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPServiceConfiguration.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_DHCPServiceConfiguration.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPServiceConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPServiceConfiguration createInstance(WBEMClient client, Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPServiceConfiguration newDataInstance = Linux_DHCPServiceConfigurationHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPServiceConfiguration modifyInstance(WBEMClient client, Linux_DHCPServiceConfiguration dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPServiceConfiguration dataInstance2 = Linux_DHCPServiceConfigurationHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPServiceConfiguration dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPServiceConfiguration.getPackages());
    }
