 ...
 * 
 * Description:  The hierarchial structure fo the dhcp viz subnets inside sharednets ,pools within subnets ..etc can be achieved by using this association.Here the Subnet entity is associated with DHCPEntity which can be any of the classes extending the DHCPEntity class.
 * 
 * generated Class
 */
...
public class Linux_DHCPSubnetsForEntity extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET {
        /**
    ...
    public Linux_DHCPSubnetsForEntity(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DHCPSubnetsForEntity(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DHCPSubnetsForEntity() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PartComponent", new CIMProperty("PartComponent", new CIMDataType(
                Linux_DHCPSubnet.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_GroupComponent_Linux_DHCPEntity(WBEMClient client,
        ...
        Linux_DHCPSubnetsForEntity fco = new Linux_DHCPSubnetsForEntity(client, namespace);
    ...
    public Linux_DHCPSubnet get_PartComponent_Linux_DHCPSubnet(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_DHCPSubnetHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_PartComponent_Linux_DHCPSubnet(Linux_DHCPSubnet newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_PartComponent_Linux_DHCPSubnet(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME
    ...
    public static CIMProperty create_PartComponent_Linux_DHCPSubnet(WBEMClient client,
            String namespace, Linux_DHCPSubnet newValue) throws WbemsmtException {
        Linux_DHCPSubnetsForEntity fco = new Linux_DHCPSubnetsForEntity(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_Linux_DHCPSubnet(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPSUBNET.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_Linux_DHCPSubnet(
            CIMProperty currentProperty, Linux_DHCPSubnet newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_DHCPSubnetsForEntity.CIM_CLASS_NAME;
    }
