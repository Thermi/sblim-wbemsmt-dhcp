...
//**********************************************************************
    ...
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_Profile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
    ...
    */        
    public final static List<CIM_Profile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_Profile> resultArrayList = new ArrayList<CIM_Profile>();
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_Profile)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_Profile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_Profile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
    ...
    */    
    public final static CIM_Profile getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_Profile.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Profile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_Profile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_Profile createInstance(WBEMClient client, CIM_Profile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
...
//**********************************************************************
    ...
    */    
    public final static CIM_Profile modifyInstance(WBEMClient client, CIM_Profile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_Profile dataInstance2 = CIM_ProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_Profile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_Profile.getPackages());
    }
