...
public class Linux_DHCPParamsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPParamsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPParamsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPParamsForEntity.");
                        resultArrayList.add(new Linux_DHCPParamsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPParamsForEntity.");
                        resultArrayList.add(new Linux_DHCPParamsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPParamsForEntity.");
                        resultArrayList.add(new Linux_DHCPParamsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPParamsForEntity getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPParamsForEntity getInstance(WBEMClient client, String namespace,
            Linux_DHCPEntity GroupComponent, Linux_DHCPParams PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPParamsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPParamsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPPARAMS.NAME,
                new CIMDataType(Linux_DHCPParams.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPParamsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPParamsForEntity createInstance(WBEMClient client,
            Linux_DHCPParamsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPParamsForEntity newDataInstance = Linux_DHCPParamsForEntityHelper.getInstance(
     ...
     */
    public final static Linux_DHCPParamsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPParamsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPParamsForEntity dataInstance2 = Linux_DHCPParamsForEntityHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPParamsForEntity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPParamsForEntity.getPackages());
    }
