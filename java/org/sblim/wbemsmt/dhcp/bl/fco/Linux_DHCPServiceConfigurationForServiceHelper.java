...
public class Linux_DHCPServiceConfigurationForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(
                                cimInstance));
                        continue;
                    }
                    Class clazz = Linux_DHCPServiceConfigurationForServiceHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPServiceConfigurationForService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPServiceConfigurationForService getInstance(WBEMClient client,
            String namespace, Linux_DHCPService Element,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPServiceConfigurationForService.PROPERTY_ELEMENT_LINUX_DHCPSERVICE.NAME,
                new CIMDataType(Linux_DHCPService.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME);

        setThis = Configuration != null ? Configuration.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_DHCPServiceConfigurationForService.PROPERTY_CONFIGURATION_LINUX_DHCPSERVICECONFIGURATION.NAME,
                new CIMDataType(Linux_DHCPServiceConfiguration.CIM_CLASS_NAME), setThis, false,
                false, Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPServiceConfigurationForService createInstance(WBEMClient client,
            Linux_DHCPServiceConfigurationForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPServiceConfigurationForService newDataInstance = Linux_DHCPServiceConfigurationForServiceHelper
     ...
     */
    public final static Linux_DHCPServiceConfigurationForService modifyInstance(WBEMClient client,
            Linux_DHCPServiceConfigurationForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPServiceConfigurationForService dataInstance2 = Linux_DHCPServiceConfigurationForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPServiceConfigurationForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPServiceConfigurationForService.getPackages());
    }
