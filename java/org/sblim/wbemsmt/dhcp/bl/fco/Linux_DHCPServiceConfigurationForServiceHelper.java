/** 
  * Linux_DHCPServiceConfigurationForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPServiceConfigurationForService
  *    
  * 
  * generated Class
  * @see Linux_DHCPServiceConfigurationForService
  */
...
public class Linux_DHCPServiceConfigurationForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPServiceConfigurationForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPServiceConfigurationForService or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPServiceConfigurationForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPServiceConfigurationForService> resultArrayList = new ArrayList<Linux_DHCPServiceConfigurationForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPServiceConfigurationForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPServiceConfigurationForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DHCPServiceConfigurationForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPServiceConfigurationForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPServiceConfigurationForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPServiceConfigurationForService dataInstance = null;
        Class<?> clazz = Linux_DHCPServiceConfigurationForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPServiceConfigurationForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPServiceConfigurationForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPServiceConfigurationForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPServiceConfigurationForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPService Element
                                                       ,Linux_DHCPServiceConfiguration Configuration
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPServiceConfigurationForService.PROPERTY_ELEMENT_LINUX_DHCPSERVICE.NAME,new CIMDataType(Linux_DHCPService.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME); 
                   
                                 setThis = Configuration != null ? Configuration.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPServiceConfigurationForService.PROPERTY_CONFIGURATION_LINUX_DHCPSERVICECONFIGURATION.NAME,new CIMDataType(Linux_DHCPServiceConfiguration.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPServiceConfigurationForService createInstance(WBEMClient client, Linux_DHCPServiceConfigurationForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPServiceConfigurationForService newDataInstance = Linux_DHCPServiceConfigurationForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPServiceConfigurationForService modifyInstance(WBEMClient client, Linux_DHCPServiceConfigurationForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPServiceConfigurationForService dataInstance2 = Linux_DHCPServiceConfigurationForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPServiceConfigurationForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPServiceConfigurationForService.getPackages());
    }
