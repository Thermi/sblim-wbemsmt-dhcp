...
public class Linux_DHCPSharednetsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DHCPSharednetsForEntityHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DHCPSharednetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPSharednetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPSharednetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPSharednetsForEntity getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPSharednetsForEntity getInstance(WBEMClient client,
            String namespace, Linux_DHCPEntity GroupComponent, Linux_DHCPSharednet PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPSharednetsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
                new CIMDataType(Linux_DHCPEntity.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_DHCPSharednetsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPSHAREDNET.NAME,
                new CIMDataType(Linux_DHCPSharednet.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPSharednetsForEntity createInstance(WBEMClient client,
            Linux_DHCPSharednetsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPSharednetsForEntity newDataInstance = Linux_DHCPSharednetsForEntityHelper
     ...
     */
    public final static Linux_DHCPSharednetsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPSharednetsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPSharednetsForEntity dataInstance2 = Linux_DHCPSharednetsForEntityHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPSharednetsForEntity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPSharednetsForEntity.getPackages());
    }
