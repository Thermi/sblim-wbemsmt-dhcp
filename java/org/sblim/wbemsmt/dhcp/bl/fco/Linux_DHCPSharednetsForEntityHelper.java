/** 
  * Linux_DHCPSharednetsForEntityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPSharednetsForEntity
  *    
  * 
  * generated Class
  * @see Linux_DHCPSharednetsForEntity
  */
...
public class Linux_DHCPSharednetsForEntityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPSharednetsForEntity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPSharednetsForEntity or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPSharednetsForEntity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPSharednetsForEntity> resultArrayList = new ArrayList<Linux_DHCPSharednetsForEntity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPSharednetsForEntityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPSharednetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPSharednetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPSharednetsForEntity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSharednetsForEntity.");
                        resultArrayList.add(new Linux_DHCPSharednetsForEntity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPSharednetsForEntity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPSharednetsForEntity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPSharednetsForEntity dataInstance = null;
        Class<?> clazz = Linux_DHCPSharednetsForEntityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPSharednetsForEntity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSharednetsForEntity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPSharednetsForEntity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPSharednetsForEntity getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPEntity GroupComponent
                                                       ,Linux_DHCPSharednet PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPSharednetsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,new CIMDataType(Linux_DHCPEntity.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPSharednetsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPSHAREDNET.NAME,new CIMDataType(Linux_DHCPSharednet.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPSharednetsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPSharednetsForEntity createInstance(WBEMClient client, Linux_DHCPSharednetsForEntity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPSharednetsForEntity newDataInstance = Linux_DHCPSharednetsForEntityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPSharednetsForEntity modifyInstance(WBEMClient client, Linux_DHCPSharednetsForEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPSharednetsForEntity dataInstance2 = Linux_DHCPSharednetsForEntityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPSharednetsForEntity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPSharednetsForEntity.getPackages());
    }
