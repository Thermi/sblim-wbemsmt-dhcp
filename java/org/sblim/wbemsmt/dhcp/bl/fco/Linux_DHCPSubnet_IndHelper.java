/** 
  * Linux_DHCPSubnet_IndHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPSubnet_Ind
  *    
  * 
  * generated Class
  * @see Linux_DHCPSubnet_Ind
  */
...
public class Linux_DHCPSubnet_IndHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPSubnet_Ind or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPSubnet_Ind.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPSubnet_Ind.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPSubnet_Ind or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPSubnet_Ind> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPSubnet_Ind> resultArrayList = new ArrayList<Linux_DHCPSubnet_Ind>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPSubnet_Ind.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPSubnet_Ind(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPSubnet_IndHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPSubnet_Ind.");
                        resultArrayList.add(new Linux_DHCPSubnet_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPSubnet_Ind.");
                        resultArrayList.add(new Linux_DHCPSubnet_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPSubnet_Ind)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSubnet_Ind.");
                        resultArrayList.add(new Linux_DHCPSubnet_Ind(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPSubnet_Ind getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPSubnet_Ind getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPSubnet_Ind dataInstance = null;
        Class<?> clazz = Linux_DHCPSubnet_IndHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPSubnet_Ind)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPSubnet_Ind.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPSubnet_Ind(cimInstance);
            }
        } catch (Exception e) {
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPSubnet_Ind createInstance(WBEMClient client, Linux_DHCPSubnet_Ind dataInstance, boolean notifyDifferencies)
    ...
    { 
        ...
        Linux_DHCPSubnet_Ind newDataInstance = Linux_DHCPSubnet_IndHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPSubnet_Ind modifyInstance(WBEMClient client, Linux_DHCPSubnet_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPSubnet_Ind dataInstance2 = Linux_DHCPSubnet_IndHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPSubnet_Ind dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPSubnet_Ind.getPackages());
    }
