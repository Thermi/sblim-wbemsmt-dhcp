...
public class Linux_DHCPHost_IndHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPHost_Ind.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(Linux_DHCPHost_Ind.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPHost_Ind.");
                        resultArrayList.add(new Linux_DHCPHost_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPHost_Ind.");
                        resultArrayList.add(new Linux_DHCPHost_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPHost_Ind.");
                        resultArrayList.add(new Linux_DHCPHost_Ind(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPHost_Ind getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPHost_Ind getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static Linux_DHCPHost_Ind createInstance(WBEMClient client,
            Linux_DHCPHost_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPHost_Ind newDataInstance = Linux_DHCPHost_IndHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DHCPHost_Ind modifyInstance(WBEMClient client,
            Linux_DHCPHost_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPHost_Ind dataInstance2 = Linux_DHCPHost_IndHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPHost_Ind dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPHost_Ind.getPackages());
    }
