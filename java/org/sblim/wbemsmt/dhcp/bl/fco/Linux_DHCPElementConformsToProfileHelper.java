/** 
  * Linux_DHCPElementConformsToProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPElementConformsToProfile
  *    
  * 
  * generated Class
  * @see Linux_DHCPElementConformsToProfile
  */
...
public class Linux_DHCPElementConformsToProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPElementConformsToProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPElementConformsToProfile or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPElementConformsToProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPElementConformsToProfile> resultArrayList = new ArrayList<Linux_DHCPElementConformsToProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPElementConformsToProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPElementConformsToProfile.");
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPElementConformsToProfile.");
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPElementConformsToProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPElementConformsToProfile.");
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPElementConformsToProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPElementConformsToProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPElementConformsToProfile dataInstance = null;
        Class<?> clazz = Linux_DHCPElementConformsToProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPElementConformsToProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPElementConformsToProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPElementConformsToProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPElementConformsToProfile getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPRegisteredProfile ConformantStandard
                                                       ,Linux_DHCPService ManagedElement
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPElementConformsToProfile.PROPERTY_CONFORMANTSTANDARD_LINUX_DHCPREGISTEREDPROFILE.NAME,new CIMDataType(Linux_DHCPRegisteredProfile.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPElementConformsToProfile.PROPERTY_MANAGEDELEMENT_LINUX_DHCPSERVICE.NAME,new CIMDataType(Linux_DHCPService.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPElementConformsToProfile createInstance(WBEMClient client, Linux_DHCPElementConformsToProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPElementConformsToProfile newDataInstance = Linux_DHCPElementConformsToProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPElementConformsToProfile modifyInstance(WBEMClient client, Linux_DHCPElementConformsToProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPElementConformsToProfile dataInstance2 = Linux_DHCPElementConformsToProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPElementConformsToProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPElementConformsToProfile.getPackages());
    }
