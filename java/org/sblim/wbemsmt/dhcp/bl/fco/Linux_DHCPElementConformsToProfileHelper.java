...
public class Linux_DHCPElementConformsToProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DHCPElementConformsToProfileHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DHCPElementConformsToProfile.");
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPElementConformsToProfile.");
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPElementConformsToProfile.");
                        resultArrayList.add(new Linux_DHCPElementConformsToProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPElementConformsToProfile getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPElementConformsToProfile getInstance(WBEMClient client,
            String namespace, Linux_DHCPRegisteredProfile ConformantStandard,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPElementConformsToProfile.PROPERTY_CONFORMANTSTANDARD_LINUX_DHCPREGISTEREDPROFILE.NAME,
                new CIMDataType(Linux_DHCPRegisteredProfile.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPElementConformsToProfile.CIM_CLASS_NAME);

        setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_DHCPElementConformsToProfile.PROPERTY_MANAGEDELEMENT_LINUX_DHCPSERVICE.NAME,
     ...
     *
     */
    public final static Linux_DHCPElementConformsToProfile createInstance(WBEMClient client,
            Linux_DHCPElementConformsToProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPElementConformsToProfile newDataInstance = Linux_DHCPElementConformsToProfileHelper
     ...
     */
    public final static Linux_DHCPElementConformsToProfile modifyInstance(WBEMClient client,
            Linux_DHCPElementConformsToProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPElementConformsToProfile dataInstance2 = Linux_DHCPElementConformsToProfileHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPElementConformsToProfile dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPElementConformsToProfile.getPackages());
    }
