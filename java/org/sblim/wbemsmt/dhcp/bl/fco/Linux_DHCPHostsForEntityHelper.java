/** 
  * Linux_DHCPHostsForEntityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPHostsForEntity
  *    
  * 
  * generated Class
  * @see Linux_DHCPHostsForEntity
  */
...
public class Linux_DHCPHostsForEntityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPHostsForEntity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPHostsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPHostsForEntity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPHostsForEntity or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPHostsForEntity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPHostsForEntity> resultArrayList = new ArrayList<Linux_DHCPHostsForEntity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPHostsForEntity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPHostsForEntityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPHostsForEntity.");
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPHostsForEntity.");
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPHostsForEntity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPHostsForEntity.");
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPHostsForEntity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPHostsForEntity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPHostsForEntity dataInstance = null;
        Class<?> clazz = Linux_DHCPHostsForEntityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPHostsForEntity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPHostsForEntity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPHostsForEntity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPHostsForEntity getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPEntity GroupComponent
                                                       ,Linux_DHCPHost PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPHostsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,new CIMDataType(Linux_DHCPEntity.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPHostsForEntity.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPHostsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPHOST.NAME,new CIMDataType(Linux_DHCPHost.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPHostsForEntity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPHostsForEntity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPHostsForEntity createInstance(WBEMClient client, Linux_DHCPHostsForEntity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPHostsForEntity newDataInstance = Linux_DHCPHostsForEntityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPHostsForEntity modifyInstance(WBEMClient client, Linux_DHCPHostsForEntity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPHostsForEntity dataInstance2 = Linux_DHCPHostsForEntityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPHostsForEntity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPHostsForEntity.getPackages());
    }
