...
public class Linux_DHCPHostsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPHostsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPHostsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPHostsForEntity.");
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPHostsForEntity.");
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPHostsForEntity.");
                        resultArrayList.add(new Linux_DHCPHostsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPHostsForEntity getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPHostsForEntity getInstance(WBEMClient client, String namespace,
            Linux_DHCPEntity GroupComponent, Linux_DHCPHost PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPHostsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPHostsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPHOST.NAME,
                new CIMDataType(Linux_DHCPHost.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPHostsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPHostsForEntity createInstance(WBEMClient client,
            Linux_DHCPHostsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPHostsForEntity newDataInstance = Linux_DHCPHostsForEntityHelper.getInstance(
     ...
     */
    public final static Linux_DHCPHostsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPHostsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPHostsForEntity dataInstance2 = Linux_DHCPHostsForEntityHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPHostsForEntity dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPHostsForEntity.getPackages());
    }
