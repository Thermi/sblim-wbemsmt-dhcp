...
public class Linux_DHCPPool_IndHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPPool_Ind.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(Linux_DHCPPool_Ind.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPPool_Ind.");
                        resultArrayList.add(new Linux_DHCPPool_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPPool_Ind.");
                        resultArrayList.add(new Linux_DHCPPool_Ind(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPPool_Ind.");
                        resultArrayList.add(new Linux_DHCPPool_Ind(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPPool_Ind getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DHCPPool_Ind getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static Linux_DHCPPool_Ind createInstance(WBEMClient client,
            Linux_DHCPPool_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPPool_Ind newDataInstance = Linux_DHCPPool_IndHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DHCPPool_Ind modifyInstance(WBEMClient client,
            Linux_DHCPPool_Ind dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPPool_Ind dataInstance2 = Linux_DHCPPool_IndHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPPool_Ind dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPPool_Ind.getPackages());
    }
