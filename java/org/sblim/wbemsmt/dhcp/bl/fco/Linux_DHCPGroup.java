...
public class Linux_DHCPGroup extends Linux_DHCPEntity {
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPGroupsForEntitys(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPGroupsForEntitys(cimClient,
    ...
    public java.util.List getAssociated_Linux_DHCPEntity_Linux_DHCPGroupsForEntityNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DHCPEntity_Linux_DHCPGroupsForEntityNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DHCPGROUPSFORENTITY,
