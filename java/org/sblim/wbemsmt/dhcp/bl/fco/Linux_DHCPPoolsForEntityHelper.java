...
public class Linux_DHCPPoolsForEntityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPPoolsForEntity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPPoolsForEntity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPPoolsForEntity.");
                        resultArrayList.add(new Linux_DHCPPoolsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPPoolsForEntity.");
                        resultArrayList.add(new Linux_DHCPPoolsForEntity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPPoolsForEntity.");
                        resultArrayList.add(new Linux_DHCPPoolsForEntity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPPoolsForEntity getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPPoolsForEntity getInstance(WBEMClient client, String namespace,
            Linux_DHCPEntity GroupComponent, Linux_DHCPPool PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPPoolsForEntity.PROPERTY_GROUPCOMPONENT_LINUX_DHCPENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPPoolsForEntity.PROPERTY_PARTCOMPONENT_LINUX_DHCPPOOL.NAME,
                new CIMDataType(Linux_DHCPPool.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPPoolsForEntity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPPoolsForEntity createInstance(WBEMClient client,
            Linux_DHCPPoolsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPPoolsForEntity newDataInstance = Linux_DHCPPoolsForEntityHelper.getInstance(
     ...
     */
    public final static Linux_DHCPPoolsForEntity modifyInstance(WBEMClient client,
            Linux_DHCPPoolsForEntity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPPoolsForEntity dataInstance2 = Linux_DHCPPoolsForEntityHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPPoolsForEntity dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPPoolsForEntity.getPackages());
    }
