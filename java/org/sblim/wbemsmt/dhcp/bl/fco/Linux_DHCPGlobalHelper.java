...
public class Linux_DHCPGlobalHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPGlobal.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPGlobal.");
                        resultArrayList.add(new Linux_DHCPGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPGlobal.");
                        resultArrayList.add(new Linux_DHCPGlobal(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPGlobal.");
                        resultArrayList.add(new Linux_DHCPGlobal(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPGlobal getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPGlobal getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPGlobal getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPGlobal.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPGlobal.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPGlobal createInstance(WBEMClient client,
            Linux_DHCPGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPGlobal newDataInstance = Linux_DHCPGlobalHelper
     ...
     */
    public final static Linux_DHCPGlobal modifyInstance(WBEMClient client,
            Linux_DHCPGlobal dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPGlobal dataInstance2 = Linux_DHCPGlobalHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPGlobal dataInstance)
            throws WbemsmtException {
