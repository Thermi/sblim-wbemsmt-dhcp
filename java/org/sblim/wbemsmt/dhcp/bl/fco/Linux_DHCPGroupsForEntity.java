/**
 * Linux_DHCPGroupsForEntity.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
 ...
 *            association.Here the Group entity is associated with DHCPEntity which can be any of
...
public class Linux_DHCPGroupsForEntity extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP {
        /**
    ...
    public Linux_DHCPGroupsForEntity(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DHCPGroupsForEntity(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DHCPGroupsForEntity() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PartComponent", new CIMProperty("PartComponent", new CIMDataType(
                Linux_DHCPGroup.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_GroupComponent_Linux_DHCPEntity(WBEMClient client,
        ...
        Linux_DHCPGroupsForEntity fco = new Linux_DHCPGroupsForEntity(client, namespace);
    ...
    public Linux_DHCPGroup get_PartComponent_Linux_DHCPGroup(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_DHCPGroupHelper
    ...
    public boolean set_PartComponent_Linux_DHCPGroup(Linux_DHCPGroup newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_PartComponent_Linux_DHCPGroup(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME
    ...
    public static CIMProperty create_PartComponent_Linux_DHCPGroup(WBEMClient client,
            String namespace, Linux_DHCPGroup newValue) throws WbemsmtException {
        Linux_DHCPGroupsForEntity fco = new Linux_DHCPGroupsForEntity(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_Linux_DHCPGroup(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DHCPGROUP.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_Linux_DHCPGroup(
            CIMProperty currentProperty, Linux_DHCPGroup newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_DHCPGroupsForEntity.CIM_CLASS_NAME;
    }
