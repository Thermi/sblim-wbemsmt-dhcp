...
public class Linux_DHCPParamsHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPParams.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPParams.");
                        resultArrayList.add(new Linux_DHCPParams(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPParams.");
                        resultArrayList.add(new Linux_DHCPParams(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPParams.");
                        resultArrayList.add(new Linux_DHCPParams(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPParams getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DHCPParams getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DHCPParams getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DHCPParams.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DHCPParams.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPParams createInstance(WBEMClient client,
            Linux_DHCPParams dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DHCPParams newDataInstance = Linux_DHCPParamsHelper
     ...
     */
    public final static Linux_DHCPParams modifyInstance(WBEMClient client,
            Linux_DHCPParams dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPParams dataInstance2 = Linux_DHCPParamsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DHCPParams dataInstance)
            throws WbemsmtException {
