/** 
  * Linux_DHCPGlobalForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DHCPGlobalForService
  *    
  * 
  * generated Class
  * @see Linux_DHCPGlobalForService
  */
...
public class Linux_DHCPGlobalForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DHCPGlobalForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DHCPGlobalForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DHCPGlobalForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DHCPGlobalForService or the subclasses if deep == true
    */        
    public final static List<Linux_DHCPGlobalForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DHCPGlobalForService> resultArrayList = new ArrayList<Linux_DHCPGlobalForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DHCPGlobalForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DHCPGlobalForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DHCPGlobalForService.");
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DHCPGlobalForService.");
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DHCPGlobalForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPGlobalForService.");
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DHCPGlobalForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DHCPGlobalForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DHCPGlobalForService dataInstance = null;
        Class<?> clazz = Linux_DHCPGlobalForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DHCPGlobalForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DHCPGlobalForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DHCPGlobalForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DHCPGlobalForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_DHCPService ManagedElement
                                                       ,Linux_DHCPGlobal SettingData
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DHCPGlobalForService.PROPERTY_MANAGEDELEMENT_LINUX_DHCPSERVICE.NAME,new CIMDataType(Linux_DHCPService.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPGlobalForService.CIM_CLASS_NAME); 
                   
                                 setThis = SettingData != null ? SettingData.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DHCPGlobalForService.PROPERTY_SETTINGDATA_LINUX_DHCPGLOBAL.NAME,new CIMDataType(Linux_DHCPGlobal.CIM_CLASS_NAME),setThis,false,false,Linux_DHCPGlobalForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPGlobalForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DHCPGlobalForService createInstance(WBEMClient client, Linux_DHCPGlobalForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DHCPGlobalForService newDataInstance = Linux_DHCPGlobalForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DHCPGlobalForService modifyInstance(WBEMClient client, Linux_DHCPGlobalForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DHCPGlobalForService dataInstance2 = Linux_DHCPGlobalForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DHCPGlobalForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DHCPGlobalForService.getPackages());
    }
