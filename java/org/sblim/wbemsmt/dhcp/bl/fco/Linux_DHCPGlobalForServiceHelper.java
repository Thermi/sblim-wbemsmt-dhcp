...
public class Linux_DHCPGlobalForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DHCPGlobalForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DHCPGlobalForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DHCPGlobalForService.");
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DHCPGlobalForService.");
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DHCPGlobalForService.");
                        resultArrayList.add(new Linux_DHCPGlobalForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DHCPGlobalForService getInstance(WBEMClient client,
    ...
    public final static Linux_DHCPGlobalForService getInstance(WBEMClient client, String namespace,
            Linux_DHCPService ManagedElement, Linux_DHCPGlobal SettingData
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DHCPGlobalForService.PROPERTY_MANAGEDELEMENT_LINUX_DHCPSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DHCPGlobalForService.PROPERTY_SETTINGDATA_LINUX_DHCPGLOBAL.NAME,
                new CIMDataType(Linux_DHCPGlobal.CIM_CLASS_NAME), setThis, false, false,
                Linux_DHCPGlobalForService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DHCPGlobalForService createInstance(WBEMClient client,
            Linux_DHCPGlobalForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DHCPGlobalForService newDataInstance = Linux_DHCPGlobalForServiceHelper.getInstance(
     ...
     */
    public final static Linux_DHCPGlobalForService modifyInstance(WBEMClient client,
            Linux_DHCPGlobalForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DHCPGlobalForService dataInstance2 = Linux_DHCPGlobalForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DHCPGlobalForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DHCPGlobalForService.getPackages());
    }
