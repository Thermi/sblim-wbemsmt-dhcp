...
public class NewSharednetWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public NewSharednetWizardContainer(AbstractBaseCimAdapter adapter,
            NewSharednetWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
