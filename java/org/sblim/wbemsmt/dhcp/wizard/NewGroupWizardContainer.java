...
public class NewGroupWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public NewGroupWizardContainer(AbstractBaseCimAdapter adapter,
            NewGroupWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
