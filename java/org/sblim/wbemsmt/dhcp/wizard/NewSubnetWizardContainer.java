...
public class NewSubnetWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public NewSubnetWizardContainer(AbstractBaseCimAdapter adapter,
            NewSubnetWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
