...
import org.sblim.wbemsmt.dhcp.bl.container.edit.*;
import org.sblim.wbemsmt.dhcp.bl.fco.*;
...
//	protected MessageList saveHost ( DHCPHostsContainer container) throws ObjectSaveException {
//		
...
//	}
//
//	protected MessageList saveSubnet ( DHCPSubnetsContainer container) throws ObjectSaveException {
//		
...
//	}
//
//	protected MessageList saveSharedNet ( DHCPSharednetsContainer container) throws ObjectSaveException {
//
...
//	}
//
//	protected MessageList savePool ( DHCPPoolsContainer container) throws ObjectSaveException {
//
...
//	}
//
//	protected MessageList saveGroup ( DHCPGroupsContainer container) throws ObjectSaveException {
//
...
//	protected void deleteHost() throws ObjectDeletionException {
//		
//		Linux_DHCPHost fco = (Linux_DHCPHost) this.fco;
...
//	}
//	
//	protected void deletePool () throws ObjectDeletionException {
//
//		Linux_DHCPPool fco = (Linux_DHCPPool) this.fco;
...
//	}
//
//	protected void deleteSubnet() throws ObjectDeletionException {
//
//		Linux_DHCPSubnet fco = (Linux_DHCPSubnet) this.fco;
//
...
//	}
//
//	protected void deleteSharednet() throws ObjectDeletionException {
//	
//		Linux_DHCPSharednet fco = (Linux_DHCPSharednet) this.fco;
...
//	}
//
//	protected void deleteGroup() throws ObjectDeletionException {
//	
//		Linux_DHCPGroup fco = (Linux_DHCPGroup) this.fco;
...
//	}
	...
	public MessageList save(DHCPGlobalOptionsContainer container){
		...
		boolean objFound = false;
			...
			if(objFound==false && fld.getConvertedControlValue ().toString ().equals("") == false){
				...
				opFco.set_InstanceID ( "WBEM_SMT:Linux_DHCPOptions::dhcp::" + fld.getLabelText () );
				...
				if (DhcpCimAdapter.isDummyMode ()) {
					...
					ArrayList globalEntityArrayList = adapter.getDhcpServiceObj ().getFco ()
					...
					Linux_DHCPOptionsForEntity globalopfco = new Linux_DHCPOptionsForEntity ();
					globalopfco.set_Linux_DHCPEntity ( globalFco );
					globalopfco.set_Linux_DHCPOptions ( opFco );
					try{
	...
	public MessageList save(DHCPGlobalParamsContainer container){
		...
		boolean objFound = false;
			...
			if(objFound==false && fld.getConvertedControlValue ().toString ().equals("") == false){
				...
				opFco.set_InstanceID ( "WBEM_SMT:Linux_DHCPParams::dhcp::" + fld.getLabelText () );
				opFco.set_Name ( fld.getLabelText () );
				opFco.set_Values ( fld.getConvertedControlValue ().toString () );
				try{
				...
				if (DhcpCimAdapter.isDummyMode ()) {
					...
					Linux_DHCPParamsForEntity globalopfco = new Linux_DHCPParamsForEntity ();
					globalopfco.set_Linux_DHCPEntity ( globalFco );
					globalopfco.set_Linux_DHCPParams ( opFco );
					try {
...
//	}
	...
	protected MessageList revert ( DHCPHostsContainer container ) throws ObjectRevertException {
		return null;
	}

	protected MessageList revert ( DHCPPoolsContainer container ) throws ObjectRevertException {
		return null;
	}
	
	protected MessageList revert ( DHCPGroupsContainer container ) throws ObjectRevertException {
		return null;
	}
	
	protected MessageList revert ( DHCPSubnetsContainer container ) throws ObjectRevertException {
		return null;
	}
	
	protected MessageList revert ( DHCPSharednetsContainer container ) throws ObjectRevertException {
		return null;
	}
	
//	protected void loadFcosFromGlobal(Linux_DHCPEntity fco , CIMClient cimclient) throws SecurityException, NoSuchMethodException, InstantiationException, ClassNotFoundException{
//		
